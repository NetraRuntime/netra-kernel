...
for variant in baseline candidate; do
  ...
  if [[ ${variant} == baseline ]]; then
    ...
    input_scope="synthetic zeros exact Qwen3.6 T8192 prefix24576 Hq16 Hkv2 D256 N64 split-KV"
  fi
...
echo "gfx1151 measured N64 split-KV counter reports: ${out_dir}/{baseline,candidate}/summary.json"
