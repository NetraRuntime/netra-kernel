...
out_dir=${1:-"${repo_dir}/build/experiments/attention-group4-qpipe"}
rocm=/opt/rocm-7.2.1
clang=${rocm}/llvm/bin/clang
hipcc=${rocm}/bin/hipcc
stem=extend_attention_wmma_n64_group4_qpipe_gfx1151
...
echo "Built gfx1151 group4 qpipe shared-KV attention experiment in ${out_dir}"
