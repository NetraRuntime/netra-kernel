...
output_dir=${OUTPUT_DIR:-$repo_root/build/gfx950-qwen36-extend-attention-gqa4}

assembly=$repo_root/kernels/gfx950/attention/verify/qwen36_extend_attention_m16_gqa4_gfx950.s
bridge=$repo_root/runtime/gfx950/attention/verify/qwen36_extend_attention_m16_gqa4_bridge.hip
header_dir=$repo_root/runtime/gfx950/attention/verify
object=$output_dir/qwen36_extend_attention_m16_gqa4_gfx950.o
hsaco=$output_dir/qwen36_extend_attention_m16_gqa4_gfx950.hsaco
library=$output_dir/libqwen36_extend_attention_m16_gqa4_bridge.so
...
"$objdump" -d --mcpu=gfx950 "$hsaco" \
  > "$output_dir/qwen36_extend_attention_m16_gqa4_gfx950.disassembly.txt"
"$readobj" --notes "$hsaco" \
  > "$output_dir/qwen36_extend_attention_m16_gqa4_gfx950.metadata.txt"

if ! grep -q 'amdgcn-amd-amdhsa--gfx950' \
    "$output_dir/qwen36_extend_attention_m16_gqa4_gfx950.metadata.txt"; then
