...
out_dir=${2:-"${repo_dir}/build/gfx950-qwen36-dense-m210-k4096"}
rocm_dir=${ROCM_DIR:-/opt/rocm}
stem=qwen36_dense_m210_k4096_fp8_mfma_m32n32_gfx950
kernel=${repo_dir}/kernels/gfx950/fp8/dense/prefill/${stem}.s
bridge=${repo_dir}/runtime/gfx950/fp8/dense/qwen36_dense_m210_k4096_bridge.hip
...
bridge_library=${out_dir}/libqwen36_dense_m210_k4096_bridge.so
...
echo "gfx950 Qwen dense M=210 K=4096 complete: ${out_dir}"
