...
out_dir=${2:-"${repo_dir}/build/gfx950-qwen36-gemma-add-rmsnorm"}
rocm_dir=${ROCM_DIR:-/opt/rocm}
stem=qwen36_gemma_add_rmsnorm_m1_n2048_gfx950
kernel=${repo_dir}/kernels/gfx950/norm/decode/experiments/${stem}.s
harness=${repo_dir}/harness/gfx950/norm/decode/${stem}.hip
bridge=${repo_dir}/runtime/gfx950/norm/decode/qwen36_gemma_add_rmsnorm_bridge.hip
bridge_header=${repo_dir}/runtime/gfx950/norm/decode/qwen36_gemma_add_rmsnorm_bridge.h
mkdir -p "$out_dir"
...
bridge_library=${out_dir}/libqwen36_gemma_add_rmsnorm_bridge.so
...
echo "gfx950 Qwen Gemma add+RMSNorm assembly complete: ${out_dir}"
