...
out_dir=${2:-"${repo_dir}/build/gfx950-qwen36-gemma-add-rmsnorm-quant"}
...
bridge=${repo_dir}/runtime/gfx950/norm/decode/qwen36_gemma_add_rmsnorm_quant_bridge.hip
bridge_header=${repo_dir}/runtime/gfx950/norm/decode/qwen36_gemma_add_rmsnorm_quant_bridge.h
...
bridge_library=${out_dir}/libqwen36_gemma_add_rmsnorm_quant_bridge.so
...
echo "gfx950 Qwen fused add+RMSNorm+FP8 assembly complete: ${out_dir}"
