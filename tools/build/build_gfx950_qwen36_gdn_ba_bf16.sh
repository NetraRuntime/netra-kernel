...
out_dir=${2:-"${repo_dir}/build/gfx950-qwen36-gdn-ba-bf16"}
rocm_dir=${ROCM_DIR:-/opt/rocm}
stem=qwen36_gdn_ba_bf16_gemv_gfx950
kernel=${repo_dir}/kernels/gfx950/linear_attention/verify/experiments/${stem}.s
harness=${repo_dir}/harness/gfx950/linear_attention/verify/${stem}.hip
...
echo "gfx950 Qwen GDN BA BF16 scalar experiment complete: ${out_dir}"
