...
out_dir=${2:-"${repo_dir}/build/gfx950-qwen36-grouped-down-m16n64-nolds"}
rocm_dir=${ROCM_DIR:-/opt/rocm}
stem=qwen36_moe_grouped_down_m16n64_nolds_fp8_gfx950
...
harness=${repo_dir}/harness/gfx950/fp8/moe/verify/qwen36_moe_grouped_m1024_n64_nolds_pipeline_gfx950.hip
bridge=${repo_dir}/runtime/gfx950/fp8/moe/qwen36_moe_grouped_verify_n64_nolds_bridge.hip
...
"${rocm_dir}/bin/hipcc" --offload-arch=gfx950 -O3 "${harness}" \
  -o "${out_dir}/qwen36_moe_grouped_m1024_n64_nolds_pipeline_gfx950_harness"
...
(
  ...
  sha256sum ./*.hsaco ./*.disassembly.txt ./*.metadata.txt \
    ./qwen36_moe_grouped_m1024_n64_nolds_pipeline_gfx950_harness \
    ./libqwen36_moe_grouped_verify_bridge.so > SHA256SUMS
)
echo "gfx950 Qwen grouped verification N64 no-LDS assembly complete: ${out_dir}"
