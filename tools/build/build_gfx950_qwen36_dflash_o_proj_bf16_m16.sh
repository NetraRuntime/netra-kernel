...
out_dir=${2:-"${repo_dir}/build/gfx950-qwen36-dflash-o-proj-bf16-m16"}
rocm_dir=${ROCM_DIR:-/opt/rocm}
stem=qwen36_dflash_o_proj_bf16_m16_gfx950
kernel=${repo_dir}/kernels/gfx950/dflash/draft/${stem}.s
bridge=${repo_dir}/runtime/gfx950/dflash/draft/qwen36_dflash_o_proj_bf16_bridge.hip
bridge_header=${repo_dir}/runtime/gfx950/dflash/draft/qwen36_dflash_o_proj_bf16_bridge.h
...
bridge_library=${out_dir}/libqwen36_dflash_o_proj_bf16_bridge.so
...
echo "gfx950 Qwen dFlash BF16 M16 output projection complete: ${out_dir}"
