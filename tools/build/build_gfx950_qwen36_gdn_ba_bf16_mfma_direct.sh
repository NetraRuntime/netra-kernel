...
out_dir=${2:-"${repo_dir}/build/gfx950-qwen36-gdn-ba-bf16-mfma-direct"}
rocm_dir=${ROCM_DIR:-/opt/rocm}
stem=qwen36_gdn_ba_bf16_mfma_direct_gfx950
kernel=${repo_dir}/kernels/gfx950/linear_attention/verify/${stem}.s
harness=${repo_dir}/harness/gfx950/linear_attention/verify/qwen36_gdn_ba_bf16_gemv_gfx950.hip
bridge=${repo_dir}/runtime/gfx950/linear_attention/verify/qwen36_gdn_ba_bf16_bridge.hip
bridge_header=${repo_dir}/runtime/gfx950/linear_attention/verify/qwen36_gdn_ba_bf16_bridge.h
...
bridge_library=${out_dir}/libqwen36_gdn_ba_bf16_bridge.so
...
echo "gfx950 Qwen GDN BA BF16 direct-MFMA assembly complete: ${out_dir}"
