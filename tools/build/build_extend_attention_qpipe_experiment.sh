...
accepted=extend_attention_wmma_n64_qpipe8_baseline_gfx1151
...
"${hipcc}" --offload-arch=gfx1151 -O3 -shared -fPIC -DNETRA_EXTEND_ATTENTION_GRID_Y=16 -DNETRA_EXTEND_ATTENTION_BLOCK_X=128 \
  -DNETRA_EXTEND_ATTENTION_KERNEL=${accepted} \
  "${repo_dir}/harness/gfx1151/attention/extend_attention_wmma_launcher.hip" \
...
"${hipcc}" --offload-arch=gfx1151 -O3 -DNETRA_EXTEND_ATTENTION_GRID_Y=16 -DNETRA_EXTEND_ATTENTION_BLOCK_X=128 \
  -DNETRA_EXTEND_ATTENTION_KERNEL=${serial} \
  "${repo_dir}/harness/gfx1151/attention/extend_attention_wmma_launcher.hip" \
