...
out_dir=${2:-"${repo_dir}/build/gfx950-qwen36-moe-down-reduce"}
...
kernel=${repo_dir}/kernels/gfx950/fp8/moe/decode/experiments/qwen36_moe_down_reduce_fp8_gfx950.s
...
echo "gfx950 Qwen M=1 MoE down/reduce assembly complete: ${out_dir}"
