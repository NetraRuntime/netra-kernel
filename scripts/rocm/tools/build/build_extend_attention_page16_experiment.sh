...
out=${1:-"${repo}/build/experiments/attention-page16"}
rocm=/opt/rocm-7.2.1
baseline=extend_attention_wmma_n64_gfx1151
candidate=extend_attention_wmma_n64_page16_gfx1151
mkdir -p "${out}"
...
echo "Built gfx1151 N64 page16 attention experiment in ${out}"
