...
out=${1:-"${repo}/build/experiments/attention-anchor1"}
rocm=/opt/rocm-7.2.1
baseline=extend_attention_wmma_n64_gfx1151
candidate=extend_attention_wmma_n64_group4_qpipe_kvbatch16_anchor1_gfx1151
mkdir -p "${out}"
...
echo "Built gfx1151 N64 bounded-anchor negative attention experiment in ${out}"
