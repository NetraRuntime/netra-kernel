...
out=${1:-"${repo}/build/experiments/attention-overlay32k"}
rocm=/opt/rocm-7.2.1
baseline=extend_attention_wmma_n64_gfx1151
candidate=extend_attention_wmma_n64_group4_qpipe_kvbatch4_overlay32k_gfx1151
mkdir -p "${out}"
...
echo "Built gfx1151 N64 32-KiB P/V-overlay attention experiment in ${out}"
