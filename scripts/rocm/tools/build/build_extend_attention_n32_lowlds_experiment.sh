...
out=${1:-"${repo}/build/experiments/attention-n32-lowlds"}
rocm=/opt/rocm-7.2.1
baseline=extend_attention_wmma_n64_gfx1151
candidate=extend_attention_wmma_n32_group4_qpipe_kvbatch8_lowlds_gfx1151
mkdir -p "${out}"
...
echo "Built gfx1151 M64xN32 32-KiB-LDS attention experiment in ${out}"
