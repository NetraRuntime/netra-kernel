...
//   y:      [8, N] fp32
//
// Launch: grid=(2,8,1), block=(256,1,1).
	...
	.macro LOAD_PAIR AOFF
	global_load_b32 v16, v1, s[4:5]
	global_load_b32 v17, v1, s[4:5] offset:2048
	s_load_b32 s20, s[8:9], \AOFF
	s_load_b32 s21, s[8:9], \AOFF+4
	// Move the scalar base while memory is outstanding. The following decode
	// provides far more than the required scalar dependency distance.
	...
	.protected mxfp4_decode_down_gfx1151
	.globl mxfp4_decode_down_gfx1151
	.p2align 8
	.type mxfp4_decode_down_gfx1151,@function
mxfp4_decode_down_gfx1151:
	...
	// Each workgroup covers 1024 output columns; each lane owns four.
	s_lshl_b32 s15, s2, 10
	v_lshlrev_b32_e32 v1, 2, v0
	s_waitcnt_depctr 0
	v_add_nc_u32_e32 v1, s15, v1
	s_lshl_b32 s15, s2, 12
...
.Lmxblock:
	...
	// Sixteen packed K rows, issued in coalesced pairs.
	LOAD_PAIR 0
	LOAD_PAIR 8
	LOAD_PAIR 16
	LOAD_PAIR 24
	...
	.p2align 6, 0
	.amdhsa_kernel mxfp4_decode_down_gfx1151
	...
	.text
.Lfunc_end0:
	.size mxfp4_decode_down_gfx1151, .Lfunc_end0-mxfp4_decode_down_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: mxfp4_decode_down_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 24
    .sgpr_spill_count: 0
    .symbol: mxfp4_decode_down_gfx1151.kd
