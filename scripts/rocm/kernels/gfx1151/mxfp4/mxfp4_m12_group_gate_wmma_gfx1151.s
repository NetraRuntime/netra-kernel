...
//
// Raw gfx1151 M12 routed-group gate/up WMMA specialization.
// Qwen3.6: N=512, K=2048, group storage stride=64 rows.
// Launch grid=(32,group_count,1), block=(32,1,1).
//
// Each group selects one expert and contains at most twelve valid rows for an
...
// [group,64,*] strides so routing and reduction buffers remain unchanged.
	...
	.protected mxfp4_m12_group_gate_wmma_gfx1151
	.globl mxfp4_m12_group_gate_wmma_gfx1151
	.p2align 8
	.type mxfp4_m12_group_gate_wmma_gfx1151,@function
...
s_lshl_b32 s14, s3, 18
s_lshl_b32 s15, s3, 17
s_waitcnt_depctr 0
s_add_u32 s4, s4, s12
s_addc_u32 s5, s5, 0
s_add_u32 s6, s6, s13
...
.Lmxblock:
	...
	// [group,64,N] row-major output; only rows 0..11 are written. Subgroup 0 writes rows 0..7;
	...
	.p2align 6, 0
	.amdhsa_kernel mxfp4_m12_group_gate_wmma_gfx1151
...
.amdhsa_kernarg_size 40
	...
	.text
.Lfunc_end0:
	.size mxfp4_m12_group_gate_wmma_gfx1151, .Lfunc_end0-mxfp4_m12_group_gate_wmma_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: mxfp4_m12_group_gate_wmma_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 23
    .sgpr_spill_count: 0
    .symbol: mxfp4_m12_group_gate_wmma_gfx1151.kd
