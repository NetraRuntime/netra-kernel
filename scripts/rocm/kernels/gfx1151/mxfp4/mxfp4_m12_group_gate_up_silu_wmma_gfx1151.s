...
//
// Raw gfx1151 M12 routed-group fused gate+up+SiLU-times-up WMMA specialization.
...
// M12 decode batch. Apply the model-exact SiLU epilogue in registers and store BF16 rows
// 0..11 using the production [group,64,*] intermediate stride.
...
.endm
	...
	.protected mxfp4_m12_group_gate_up_silu_wmma_gfx1151
	.globl mxfp4_m12_group_gate_up_silu_wmma_gfx1151
	.p2align 8
	.type mxfp4_m12_group_gate_up_silu_wmma_gfx1151,@function
...
// Gate accumulator-to-row-major transform.
...
// Preserve the four gate values whose registers the up transform reuses.
v_mov_b32_e32 v40, v16
v_mov_b32_e32 v41, v17
v_mov_b32_e32 v42, v18
v_mov_b32_e32 v43, v19

// Up accumulator-to-row-major transform.
...
// Identical model-native epilogue to silu_mul_m12_group_bf16_gfx1151,
// but values never leave registers as gate/up FP32 intermediates.
v_mov_b32_e32 v44, 0xbfb8aa3b
v_mov_b32_e32 v45, 0x3f800000
v_lshlrev_b32_e32 v11, 1, v3
v_lshl_add_u32 v11, v2, 13, v11

.macro SILU_MUL_STORE G U
v_mul_f32_e32 v46, \G, v44
v_exp_f32_e32 v46, v46
v_add_f32_e32 v46, v45, v46
v_rcp_f32_e32 v46, v46
v_mul_f32_e32 v47, \G, \U
v_mul_f32_e32 v47, v47, v46
v_lshrrev_b32_e32 v48, 16, v47
v_and_b32_e32 v48, 1, v48
v_add_nc_u32_e32 v48, 0x7fff, v48
v_add_nc_u32_e32 v47, v48, v47
v_lshrrev_b32_e32 v47, 16, v47
global_store_short v11, v47, s[16:17]
v_add_nc_u32_e32 v11, 1024, v11
.endm

SILU_MUL_STORE v40 v16
SILU_MUL_STORE v36 v69
SILU_MUL_STORE v41 v17
SILU_MUL_STORE v37 v70
s_mov_b32 s30, exec_lo
v_cmpx_eq_u32_e32 0, v2
SILU_MUL_STORE v42 v18
SILU_MUL_STORE v38 v71
SILU_MUL_STORE v43 v19
SILU_MUL_STORE v39 v72
s_mov_b32 exec_lo, s30
s_endpgm

	.section .rodata,"a",@progbits
	.p2align 6, 0
	.amdhsa_kernel mxfp4_m12_group_gate_up_silu_wmma_gfx1151
...
.amdhsa_kernarg_size 56
	...
	.text
.Lfunc_end0:
	.size mxfp4_m12_group_gate_up_silu_wmma_gfx1151, .Lfunc_end0-mxfp4_m12_group_gate_up_silu_wmma_gfx1151
...
amdhsa.kernels:
  - .args:
      ...
      - { .name: expert_ids, .offset: 40, .size: 8,
          .value_kind: global_buffer, .address_space: global,
          .actual_access: read_only }
      - { .name: intermediate_output_groups_m64, .offset: 48, .size: 8,
          .value_kind: global_buffer, .address_space: global,
    ...
    .name: mxfp4_m12_group_gate_up_silu_wmma_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 33
    .sgpr_spill_count: 0
    .symbol: mxfp4_m12_group_gate_up_silu_wmma_gfx1151.kd
