...
// Experimental kvbatch16-anchor1: retain the online-softmax anchor until a tile maximum exceeds it by 1.0; omit accumulator scaling between re-anchors. Grid=(M/64,4,1), block=512.
...
.protected extend_attention_wmma_n64_group4_qpipe_kvbatch16_anchor1_gfx1151
.globl extend_attention_wmma_n64_group4_qpipe_kvbatch16_anchor1_gfx1151
.p2align 8
.type extend_attention_wmma_n64_group4_qpipe_kvbatch16_anchor1_gfx1151,@function
extend_attention_wmma_n64_group4_qpipe_kvbatch16_anchor1_gfx1151:
...
.Lmask_done:
  ...
  .rept 8
    ...
    ALLREDUCE_MAX 225, 224
    v_max_f32_e32 v[216+SR], v[216+SR], v225
    // Bounded fixed-anchor softmax: scores may rise at most 1.0 above the
    // retained anchor. Re-anchor only beyond that bound, keeping BF16 P and
    // FP32 numerator/denominator finite while avoiding per-tile O scaling.
    v_add_f32_e32 v225, 1.0, v[32+SR]
    v_cmp_gt_f32_e32 vcc_lo, v[216+SR], v225
    v_cndmask_b32_e32 v[216+SR], v[32+SR], v[216+SR], vcc_lo
  ...
  // Skip 128 accumulator multiplies only when all row scales are exactly 1.
  s_mov_b32 s42, 0
  .set AR, 0
  .rept 8
    v_cmp_neq_f32_e32 vcc_lo, 1.0, v[48+AR]
    s_or_b32 s42, s42, vcc_lo
    .set AR, AR+1
  .endr
  s_cmp_eq_u32 s42, 0
  s_cbranch_scc1 .Lskip_output_rescale
  .set OT, 64
  .rept 16
    RESCALE_TILE OT
    .set OT, OT+8
  .endr
.Lskip_output_rescale:
...
.p2align 6, 0
.amdhsa_kernel extend_attention_wmma_n64_group4_qpipe_kvbatch16_anchor1_gfx1151
...
.text
.Lfunc_end0:
.size extend_attention_wmma_n64_group4_qpipe_kvbatch16_anchor1_gfx1151, .Lfunc_end0-extend_attention_wmma_n64_group4_qpipe_kvbatch16_anchor1_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: extend_attention_wmma_n64_group4_qpipe_kvbatch16_anchor1_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 64
    .sgpr_spill_count: 0
    .symbol: extend_attention_wmma_n64_group4_qpipe_kvbatch16_anchor1_gfx1151.kd
