...
// V4 CU-mode duplicates H per wave after V2 fixed the rejected prototype's missing Q rows 4..7 in every eight-row group.
// Rejected experiment: inherited the pre-fix second-half gate byte-offset defect.
...
.protected gdn_chunk_o_bv32_two_wave_cu_gfx1151
.globl gdn_chunk_o_bv32_two_wave_cu_gfx1151
.p2align 8
.type gdn_chunk_o_bv32_two_wave_cu_gfx1151,@function
gdn_chunk_o_bv32_two_wave_cu_gfx1151:
  ...
  // Stage private H[BV32,128] copies at LDS 8192 and 16384.
  v_and_b32_e32 v207, 1, v201
  v_lshlrev_b32_e32 v212, 13, v2
  .set HR, 0
  .rept 16
    v_add_nc_u32_e32 v202, (HR*2), v207
    ...
    v_add_nc_u32_e32 v205, v212, v205
    ds_write_b128 v205, v[208:211]
    .set HR, HR+1
  .endr

  // Stage the full chunk's g[64,head] at LDS 24576.
  ...
  .rept 8
    ...
    v_add_nc_u32_e32 v206, v212, v206
...
.p2align 6, 0
.amdhsa_kernel gdn_chunk_o_bv32_two_wave_cu_gfx1151
...
.text
.Lfunc_end0:
.size gdn_chunk_o_bv32_two_wave_cu_gfx1151, .Lfunc_end0-gdn_chunk_o_bv32_two_wave_cu_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: gdn_chunk_o_bv32_two_wave_cu_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 46
    .sgpr_spill_count: 0
    .symbol: gdn_chunk_o_bv32_two_wave_cu_gfx1151.kd
