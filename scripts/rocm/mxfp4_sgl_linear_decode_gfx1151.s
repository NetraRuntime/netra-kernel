...
//
// Raw gfx1151 MXFP4 linear decode kernel with runtime N and K.
// packed=[K/2,N], scales=[K/32,N], activation=[K] BF16,
// output=[N] BF16. N and K must be multiples of 4 and 32 respectively.
// grid=(ceil(N/512),1,1), block=(128,1,1); each lane owns four outputs.
	...
	.protected mxfp4_sgl_linear_decode_gfx1151
	.globl mxfp4_sgl_linear_decode_gfx1151
	.p2align 8
	.type mxfp4_sgl_linear_decode_gfx1151,@function
...
.Lmxblock:
	...
	FP32_TO_BF16 v8 v16
	FP32_TO_BF16 v9 v16
	FP32_TO_BF16 v10 v16
	FP32_TO_BF16 v11 v16
	v_lshl_or_b32 v8, v9, 16, v8
	v_lshl_or_b32 v9, v11, 16, v10
	v_lshlrev_b32_e32 v2, 1, v1
	global_store_b64 v2, v[8:9], s[10:11]
	s_endpgm

	.section .rodata,"a",@progbits
	.p2align 6, 0
	.amdhsa_kernel mxfp4_sgl_linear_decode_gfx1151
	...
	.text
.Lfunc_end0:
	.size mxfp4_sgl_linear_decode_gfx1151, .Lfunc_end0-mxfp4_sgl_linear_decode_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: mxfp4_sgl_linear_decode_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 24
    .sgpr_spill_count: 0
    .symbol: mxfp4_sgl_linear_decode_gfx1151.kd
