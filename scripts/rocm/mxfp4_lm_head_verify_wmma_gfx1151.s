...
//
// Raw gfx1151 WMMA MXFP4 LM-head speculative verify.
// M=12 (activation padded to 16), N=248320, K=2048.
// grid=(15520,1,1), block=(32,1,1).
	...
	v_add_nc_u32_e32 v13, 248320, \BASE
	global_load_ubyte v49, v13, s[4:5]
	v_add_nc_u32_e32 v14, 496640, \BASE
	global_load_ubyte v50, v14, s[4:5]
	v_add_nc_u32_e32 v15, 744960, \BASE
	global_load_ubyte v51, v15, s[4:5]
	s_waitcnt vmcnt(0)
	...
	.protected mxfp4_lm_head_verify_wmma_gfx1151
	.globl mxfp4_lm_head_verify_wmma_gfx1151
	.p2align 8
	.type mxfp4_lm_head_verify_wmma_gfx1151,@function
mxfp4_lm_head_verify_wmma_gfx1151:
	s_clause 0x1
...
.Lmxblock:
	...
	v_add_nc_u32_e32 v12, 1986560, v9
	LOAD_HALF 32 v12
	s_waitcnt lgkmcnt(0)
	v_wmma_f32_16x16x16_bf16 v[40:47], v[16:23], v[24:31], v[40:47]
	...
	v_mul_lo_u32 v12, v2, 7946240
	v_add_nc_u32_e32 v11, v12, v11
	global_store_b32 v11, v16, s[10:11]
	v_add_nc_u32_e32 v11, 993280, v11
	...
	.p2align 6, 0
	.amdhsa_kernel mxfp4_lm_head_verify_wmma_gfx1151
	...
	.text
.Lfunc_end0:
	.size mxfp4_lm_head_verify_wmma_gfx1151, .Lfunc_end0-mxfp4_lm_head_verify_wmma_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: mxfp4_lm_head_verify_wmma_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 23
    .sgpr_spill_count: 0
    .symbol: mxfp4_lm_head_verify_wmma_gfx1151.kd
