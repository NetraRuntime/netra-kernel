...
export SGLANG_NETRA_ENABLE_BF16_QKV=${SGLANG_NETRA_ENABLE_BF16_QKV:-1}
export SGLANG_NETRA_ENABLE_BF16_SHARED_GATE_UP_SILU=${SGLANG_NETRA_ENABLE_BF16_SHARED_GATE_UP_SILU:-1}
export SGLANG_NETRA_ENABLE_BF16_SHARED_DOWN=${SGLANG_NETRA_ENABLE_BF16_SHARED_DOWN:-1}
