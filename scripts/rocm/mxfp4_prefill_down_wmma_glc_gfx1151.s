...
// Qwen3.6 expert down: N=2048, K=512, 64 padded rows per group.
// grid=(128, group_count, 1), block=(32,1,1).
	...
	.protected mxfp4_prefill_down_wmma_gfx1151
	.globl mxfp4_prefill_down_wmma_gfx1151
	.p2align 8
	.type mxfp4_prefill_down_wmma_gfx1151,@function
mxfp4_prefill_down_wmma_gfx1151:
	...
	// Per-expert packed/scales are 512 KiB/32 KiB for both projections.
	s_lshl_b32 s15, s14, 19
	s_lshl_b32 s16, s14, 15
	// One 64-row A group is 64 KiB; C is 512 KiB.
	s_lshl_b32 s17, s3, 16
	s_lshl_b32 s18, s3, 19
	s_waitcnt_depctr 0
	s_add_u32 s4, s4, s15
	s_addc_u32 s5, s5, 0
	s_add_u32 s6, s6, s16
...
.Lmxblock:
	global_load_ubyte v104, v10, s[6:7] glc
	global_load_ubyte v80, v9, s[4:5] glc
	global_load_ubyte v81, v9, s[4:5] offset:2048 glc
	v_add_nc_u32_e32 v14, 4096, v9
	global_load_ubyte v82, v14, s[4:5] glc
	global_load_ubyte v83, v14, s[4:5] offset:2048 glc
	v_add_nc_u32_e32 v12, 16384, v9
	global_load_ubyte v84, v12, s[4:5] glc
	global_load_ubyte v85, v12, s[4:5] offset:2048 glc
	v_add_nc_u32_e32 v14, 4096, v12
	global_load_ubyte v86, v14, s[4:5] glc
	global_load_ubyte v87, v14, s[4:5] offset:2048 glc
	s_waitcnt vmcnt(0)
	...
	.p2align 6, 0
	.amdhsa_kernel mxfp4_prefill_down_wmma_gfx1151
	...
	.text
.Lfunc_end0:
	.size mxfp4_prefill_down_wmma_gfx1151, .Lfunc_end0-mxfp4_prefill_down_wmma_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: mxfp4_prefill_down_wmma_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 22
    .sgpr_spill_count: 0
    .symbol: mxfp4_prefill_down_wmma_gfx1151.kd
