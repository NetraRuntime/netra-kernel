    ...
    *,
    ...
    if activation_inputs is None:
        tensors.extend((
            ...
            Tensor(names["input_scale"], ("M", k // activation_block), DType.FP32, "row_major", "input"),
        ))
    ...
    tensors.extend((
        ...
        Tensor(names["weight_scale"], (n // weight_blocks[0], k // weight_blocks[1]), DType.FP32, "row_major", "weight", persistent=True),
