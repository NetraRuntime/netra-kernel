...
// Experimental raw gfx1151 combined LDS-pipelined Qwen3.6 GDN chunk-output: fused gated qh + causal qk + Av.
...
.protected gdn_chunk_o_bv32_ldspipe_combined_gfx1151
.globl gdn_chunk_o_bv32_ldspipe_combined_gfx1151
.p2align 8
.type gdn_chunk_o_bv32_ldspipe_combined_gfx1151,@function
gdn_chunk_o_bv32_ldspipe_combined_gfx1151:
  ...
  // Eight K16 steps; issue Q and both H fragments before one LDS wait.
  .set DK, 0
  .rept 8
    ...
    v_add_nc_u32_e32 v207, 4096, v206
    ds_load_b128 v[112:115], v207
    s_waitcnt lgkmcnt(0)
    ...
    ds_swizzle_b32 v116, v112 offset:swizzle(SWAP,16)
    ds_swizzle_b32 v117, v113 offset:swizzle(SWAP,16)
    ds_swizzle_b32 v118, v114 offset:swizzle(SWAP,16)
    ds_swizzle_b32 v119, v115 offset:swizzle(SWAP,16)
    s_waitcnt lgkmcnt(0)
    v_wmma_f32_16x16x16_bf16 v[64:71], v[8:15], v[16:23], v[64:71]
    v_wmma_f32_16x16x16_bf16 v[72:79], v[8:15], v[112:119], v[72:79]
    .set DK, DK+1
  .endr
  ...
  .rept 4
    ...
    .rept 2
      ...
      ds_load_u16 v[112+OB*8], v206 offset:0
      ds_load_u16_d16_hi v[112+OB*8], v206 offset:64
      ds_load_u16 v[113+OB*8], v206 offset:128
      ds_load_u16_d16_hi v[113+OB*8], v206 offset:192
      ds_load_u16 v[114+OB*8], v206 offset:256
      ds_load_u16_d16_hi v[114+OB*8], v206 offset:320
      ds_load_u16 v[115+OB*8], v206 offset:384
      ds_load_u16_d16_hi v[115+OB*8], v206 offset:448
      .set OB, OB+1
    .endr
    s_waitcnt lgkmcnt(0)
    ds_swizzle_b32 v12, v8 offset:swizzle(SWAP,16)
    ...
    .set OB, 0
    .rept 2
      ds_swizzle_b32 v[116+OB*8], v[112+OB*8] offset:swizzle(SWAP,16)
      ds_swizzle_b32 v[117+OB*8], v[113+OB*8] offset:swizzle(SWAP,16)
      ds_swizzle_b32 v[118+OB*8], v[114+OB*8] offset:swizzle(SWAP,16)
      ds_swizzle_b32 v[119+OB*8], v[115+OB*8] offset:swizzle(SWAP,16)
      .set OB, OB+1
    .endr
    s_waitcnt lgkmcnt(0)
    v_wmma_f32_16x16x16_bf16 v[64:71], v[8:15], v[112:119], v[64:71]
    v_wmma_f32_16x16x16_bf16 v[72:79], v[8:15], v[120:127], v[72:79]
    .set VT, VT+1
  .endr
...
.p2align 6, 0
.amdhsa_kernel gdn_chunk_o_bv32_ldspipe_combined_gfx1151
...
.text
.Lfunc_end0:
.size gdn_chunk_o_bv32_ldspipe_combined_gfx1151, .Lfunc_end0-gdn_chunk_o_bv32_ldspipe_combined_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: gdn_chunk_o_bv32_ldspipe_combined_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 44
    .sgpr_spill_count: 0
    .symbol: gdn_chunk_o_bv32_ldspipe_combined_gfx1151.kd
