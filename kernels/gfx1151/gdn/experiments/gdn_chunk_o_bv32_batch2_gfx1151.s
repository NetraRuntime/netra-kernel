...
// Experimental raw gfx1151 batch2 Qwen3.6 GDN chunk-output: fused gated qh + causal qk + Av.
...
.protected gdn_chunk_o_bv32_batch2_gfx1151
.globl gdn_chunk_o_bv32_batch2_gfx1151
.p2align 8
.type gdn_chunk_o_bv32_batch2_gfx1151,@function
gdn_chunk_o_bv32_batch2_gfx1151:
  ...
  // Stage Q[64,128] row-major at LDS 0. Batch two b128 transfers per wait.
  .set QR, 0
  .rept 4
    v_add_nc_u32_e32 v202, (QR*16), v201
    ...
    v_add_nc_u32_e32 v202, (QR*16+8), v201
    v_add_nc_u32_e32 v203, s28, v202
    v_lshlrev_b32_e32 v204, 12, v203
    v_add_nc_u32_e32 v204, s29, v204
    v_lshl_add_u32 v204, v200, 4, v204
    v_lshlrev_b32_e32 v206, 8, v202
    v_lshl_add_u32 v206, v200, 4, v206
    global_load_b128 v[212:215], v204, s[8:9]
    s_waitcnt vmcnt(0)
    ds_write_b128 v205, v[208:211]
    ds_write_b128 v206, v[212:215]
    .set QR, QR+1
  .endr

  // Stage H[BV32,128] row-major at LDS 16384. Batch two b128 transfers per wait.
  .set HR, 0
  .rept 2
    v_add_nc_u32_e32 v202, (HR*16), v201
    ...
    v_add_nc_u32_e32 v202, (HR*16+8), v201
    v_lshlrev_b32_e32 v204, 8, v202
    v_add_nc_u32_e32 v204, s30, v204
    v_lshl_add_u32 v204, v200, 4, v204
    v_lshlrev_b32_e32 v206, 8, v202
    ...
    global_load_b128 v[212:215], v204, s[14:15]
    s_waitcnt vmcnt(0)
    ds_write_b128 v205, v[208:211]
    ds_write_b128 v206, v[212:215]
    .set HR, HR+1
  ...
  .set KR, 0
  .rept 4
    v_add_nc_u32_e32 v202, (KR*16), v201
    v_add_nc_u32_e32 v203, s28, v202
    v_lshlrev_b32_e32 v204, 12, v203
    v_add_nc_u32_e32 v204, s29, v204
    v_lshl_add_u32 v204, v200, 4, v204
    ...
    v_add_nc_u32_e32 v202, (KR*16+8), v201
    v_add_nc_u32_e32 v203, s28, v202
    v_lshlrev_b32_e32 v204, 12, v203
    v_add_nc_u32_e32 v204, s29, v204
    v_lshl_add_u32 v204, v200, 4, v204
    ...
    v_lshl_add_u32 v206, v200, 4, v206
    v_add_nc_u32_e32 v206, 16384, v206
    global_load_b128 v[212:215], v204, s[10:11]
    s_waitcnt vmcnt(0)
    ds_write_b128 v205, v[208:211]
    ds_write_b128 v206, v[212:215]
    .set KR, KR+1
  ...
  // Stage V[64,32] row-major at LDS 16384. Batch both b128 transfers per wait.
  ...
  v_add_nc_u32_e32 v202, 32, v201
  v_add_nc_u32_e32 v203, s28, v202
  v_lshlrev_b32_e32 v204, 13, v203
  v_lshl_add_u32 v204, s26, 8, v204
  v_lshl_add_u32 v204, s2, 6, v204
  v_lshl_add_u32 v204, v200, 4, v204
  v_lshlrev_b32_e32 v206, 6, v202
  v_lshl_add_u32 v206, v200, 4, v206
  v_add_nc_u32_e32 v206, 16384, v206
  global_load_b128 v[212:215], v204, s[12:13]
  s_waitcnt vmcnt(0)
  ds_write_b128 v205, v[208:211]
  ds_write_b128 v206, v[212:215]
  s_waitcnt lgkmcnt(0)
...
.p2align 6, 0
.amdhsa_kernel gdn_chunk_o_bv32_batch2_gfx1151
...
.text
.Lfunc_end0:
.size gdn_chunk_o_bv32_batch2_gfx1151, .Lfunc_end0-gdn_chunk_o_bv32_batch2_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: gdn_chunk_o_bv32_batch2_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 44
    .sgpr_spill_count: 0
    .symbol: gdn_chunk_o_bv32_batch2_gfx1151.kd
