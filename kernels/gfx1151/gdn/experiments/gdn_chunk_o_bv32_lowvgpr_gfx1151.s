...
// REJECTED EXPERIMENT: lower-VGPR and dependency-wait variants remained nondeterministic.
// Do not ship or integrate; see docs/netra/notes/gfx1151-gdn-chunk-o-repeatability-rejection-2026-07-30.md.
// Raw gfx1151 Qwen3.6 GDN chunk-output: fused gated qh + causal qk + Av.
...
.protected gdn_chunk_o_bv32_lowvgpr_gfx1151
.globl gdn_chunk_o_bv32_lowvgpr_gfx1151
.p2align 8
.type gdn_chunk_o_bv32_lowvgpr_gfx1151,@function
gdn_chunk_o_bv32_lowvgpr_gfx1151:
  ...
  v_and_b32_e32 v100, 15, v0          // 16-byte vector index
  v_lshrrev_b32_e32 v101, 4, v0       // loader row 0..7

  // Stage Q[64,128] row-major at LDS 0. Each thread loads eight b128s.
  .set QR, 0
  .rept 8
    v_add_nc_u32_e32 v102, (QR*8), v101
    v_add_nc_u32_e32 v103, s28, v102
    v_lshlrev_b32_e32 v104, 12, v103
    v_add_nc_u32_e32 v104, s29, v104
    v_lshl_add_u32 v104, v100, 4, v104
    global_load_b128 v[108:111], v104, s[8:9]
    s_waitcnt vmcnt(0)
    v_lshlrev_b32_e32 v105, 8, v102
    v_lshl_add_u32 v105, v100, 4, v105
    ds_write_b128 v105, v[108:111]
    s_waitcnt lgkmcnt(0)
    .set QR, QR+1
  .endr
  ...
  .set HR, 0
  .rept 4
    v_add_nc_u32_e32 v102, (HR*8), v101
    v_lshlrev_b32_e32 v104, 8, v102
    v_add_nc_u32_e32 v104, s30, v104
    v_lshl_add_u32 v104, v100, 4, v104
    global_load_b128 v[108:111], v104, s[14:15]
    s_waitcnt vmcnt(0)
    v_lshlrev_b32_e32 v105, 8, v102
    v_lshl_add_u32 v105, v100, 4, v105
    v_add_nc_u32_e32 v105, 16384, v105
    ds_write_b128 v105, v[108:111]
    s_waitcnt lgkmcnt(0)
    .set HR, HR+1
  .endr
  ...
  v_add_nc_u32_e32 v102, s28, v0
  v_lshlrev_b32_e32 v104, 7, v102
  v_lshl_add_u32 v104, s26, 2, v104
  global_load_dword v108, v104, s[16:17]
  s_waitcnt vmcnt(0)
  v_lshlrev_b32_e32 v105, 2, v0
  v_add_nc_u32_e32 v105, 24576, v105
  ...
  .rept 8
    ...
    v_lshlrev_b32_e32 v106, 8, v3
    v_lshl_add_u32 v106, v4, 4, v106
    v_add_nc_u32_e32 v106, (16384+DK*32), v106
    ...
    v_add_nc_u32_e32 v106, 4096, v106
    ds_load_b128 v[16:19], v106
    s_waitcnt lgkmcnt(0)
    ds_swizzle_b32 v20, v16 offset:swizzle(SWAP,16)
    ds_swizzle_b32 v21, v17 offset:swizzle(SWAP,16)
  ...
  .set MR, 0
  .rept 8
    v_lshlrev_b32_e32 v106, 4, v2
    v_add_nc_u32_e32 v106, v4, v106
    v_add_nc_u32_e32 v106, (MR*2), v106
    v_lshlrev_b32_e32 v106, 2, v106
    v_add_nc_u32_e32 v106, 24576, v106
    ds_load_b32 v108, v106
    s_waitcnt lgkmcnt(0)
    v_mul_f32_e32 v108, 0x3fb8aa3b, v108
    v_exp_f32_e32 v108, v108
    v_mul_f32_e32 v[64+MR], v[64+MR], v108
    v_mul_f32_e32 v[72+MR], v[72+MR], v108
    .set MR, MR+1
  .endr
  ...
  .set KR, 0
  .rept 8
    v_add_nc_u32_e32 v102, (KR*8), v101
    v_add_nc_u32_e32 v103, s28, v102
    v_lshlrev_b32_e32 v104, 12, v103
    v_add_nc_u32_e32 v104, s29, v104
    v_lshl_add_u32 v104, v100, 4, v104
    global_load_b128 v[108:111], v104, s[10:11]
    s_waitcnt vmcnt(0)
    v_lshlrev_b32_e32 v105, 8, v102
    v_lshl_add_u32 v105, v100, 4, v105
    v_add_nc_u32_e32 v105, 16384, v105
  ...
  .rept 8
    ...
    .rept 4
      v_lshlrev_b32_e32 v106, 8, v3
      v_lshl_add_u32 v106, v4, 4, v106
      v_add_nc_u32_e32 v106, (16384+KT*4096+DK*32), v106
      ds_load_b128 v[16:19], v106
      s_waitcnt lgkmcnt(0)
      ds_swizzle_b32 v20, v16 offset:swizzle(SWAP,16)
      ds_swizzle_b32 v21, v17 offset:swizzle(SWAP,16)
  ...
  s_waitcnt vmcnt(0)
  v_lshlrev_b32_e32 v105, 2, v0
  v_add_nc_u32_e32 v105, 8192, v105
  ds_write_b32 v105, v108
  s_mov_b32 exec_lo, s42
  s_waitcnt lgkmcnt(0)
  s_barrier
  ...
  .set GC, 0
  .rept 4
    v_add_nc_u32_e32 v106, (GC*16), v3
    v_lshlrev_b32_e32 v106, 2, v106
    v_add_nc_u32_e32 v106, 8192, v106
    ds_load_b32 v[80+GC], v106
    .set GC, GC+1
  .endr
  .set GR, 0
  .rept 8
    v_lshlrev_b32_e32 v106, 4, v2
    v_add_nc_u32_e32 v106, v4, v106
    v_add_nc_u32_e32 v106, (GR*2), v106
    v_lshlrev_b32_e32 v106, 2, v106
    v_add_nc_u32_e32 v106, 8192, v106
    ds_load_b32 v[84+GR], v106
    .set GR, GR+1
  .endr
  s_waitcnt lgkmcnt(0)
  ...
  .set VR, 0
  .rept 2
    v_add_nc_u32_e32 v102, (VR*32), v101
    v_add_nc_u32_e32 v103, s28, v102
    v_lshlrev_b32_e32 v104, 13, v103
    v_lshl_add_u32 v104, s26, 8, v104
    v_lshl_add_u32 v104, s2, 6, v104
    v_lshl_add_u32 v104, v100, 4, v104
    global_load_b128 v[108:111], v104, s[12:13]
    s_waitcnt vmcnt(0)
    v_lshlrev_b32_e32 v105, 6, v102
    v_lshl_add_u32 v105, v100, 4, v105
    v_add_nc_u32_e32 v105, 16384, v105
    ds_write_b128 v105, v[108:111]
    s_waitcnt lgkmcnt(0)
  ...
  .rept 4
    ...
    .set OB, 0
    .rept 2
      v_lshlrev_b32_e32 v106, 9, v4
      v_lshl_add_u32 v106, v3, 1, v106
      v_add_nc_u32_e32 v106, (16384+VT*1024+OB*32), v106
      ds_load_u16 v16, v106 offset:0
      ds_load_u16_d16_hi v16, v106 offset:64
      ds_load_u16 v17, v106 offset:128
      ds_load_u16_d16_hi v17, v106 offset:192
      ds_load_u16 v18, v106 offset:256
      ds_load_u16_d16_hi v18, v106 offset:320
      ds_load_u16 v19, v106 offset:384
      ds_load_u16_d16_hi v19, v106 offset:448
      s_waitcnt lgkmcnt(0)
      ds_swizzle_b32 v20, v16 offset:swizzle(SWAP,16)
      ds_swizzle_b32 v21, v17 offset:swizzle(SWAP,16)
      ds_swizzle_b32 v22, v18 offset:swizzle(SWAP,16)
  ...
  .rept 2
    ...
    .rept 8
      ...
      v_add_nc_u32_e32 v102, (WR*2), v6
      v_add_nc_u32_e32 v102, s28, v102
      v_lshlrev_b32_e32 v104, 13, v102
      v_lshl_add_u32 v104, s26, 8, v104
      v_lshl_add_u32 v104, s2, 6, v104
      v_lshl_add_u32 v104, v3, 1, v104
      v_add_nc_u32_e32 v104, (OB*32), v104
      global_store_short v104, v109, s[18:19]
...
.p2align 6, 0
.amdhsa_kernel gdn_chunk_o_bv32_lowvgpr_gfx1151
...
.text
.Lfunc_end0:
.size gdn_chunk_o_bv32_lowvgpr_gfx1151, .Lfunc_end0-gdn_chunk_o_bv32_lowvgpr_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: gdn_chunk_o_bv32_lowvgpr_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 44
    .sgpr_spill_count: 0
    .symbol: gdn_chunk_o_bv32_lowvgpr_gfx1151.kd
