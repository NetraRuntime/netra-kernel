...
// Raw gfx1151 Qwen3.6 GDN recompute W/U with A reuse across four output tiles.
...
.macro LOAD_B_FRAGMENT base
  ds_load_u16 v16, \base offset:0
  ds_load_u16_d16_hi v16, \base offset:128
  ds_load_u16 v17, \base offset:256
  ds_load_u16_d16_hi v17, \base offset:384
  ds_load_u16 v18, \base offset:512
  ds_load_u16_d16_hi v18, \base offset:640
  ds_load_u16 v19, \base offset:768
  ds_load_u16_d16_hi v19, \base offset:896
  s_waitcnt lgkmcnt(0)
...
.macro COMPUTE_TILE tile, is_w
  ...
  .rept 4
    ...
    .rept 4
      ...
      v_add_nc_u32_e32 v129, (8192+KT*2048+OB*32), v129
      LOAD_B_FRAGMENT v129
      v_wmma_f32_16x16x16_bf16 v[96+OB*8:103+OB*8], v[8:15], v[16:23], v[96+OB*8:103+OB*8]
      .set OB, OB+1
    .endr
    .set KT, KT+1
  .endr
...
.protected recompute_w_u_reuse_a_gfx1151
.globl recompute_w_u_reuse_a_gfx1151
.p2align 8
.type recompute_w_u_reuse_a_gfx1151,@function
recompute_w_u_reuse_a_gfx1151:
...
.p2align 6, 0
.amdhsa_kernel recompute_w_u_reuse_a_gfx1151
...
.text
.Lfunc_end0:
.size recompute_w_u_reuse_a_gfx1151, .Lfunc_end0-recompute_w_u_reuse_a_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: recompute_w_u_reuse_a_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 40
    .sgpr_spill_count: 0
    .symbol: recompute_w_u_reuse_a_gfx1151.kd
