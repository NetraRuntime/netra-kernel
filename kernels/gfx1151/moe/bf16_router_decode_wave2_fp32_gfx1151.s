...
//
// Accepted raw gfx1151 BF16-input, FP32-output router GEMV.
// Fixed M=1, N=256, K=2048, row-major physical weights [N,K].
// Each wave32 computes two rows; each workgroup contains eight waves.
...
.protected bf16_router_decode_wave2_fp32_gfx1151
.globl bf16_router_decode_wave2_fp32_gfx1151
.p2align 8
.type bf16_router_decode_wave2_fp32_gfx1151,@function
...
global_store_b32 v2, v13, s[8:9]
s_endpgm

.section .rodata,"a",@progbits
.p2align 6, 0
.amdhsa_kernel bf16_router_decode_wave2_fp32_gfx1151
...
.text
.Lfunc_end0:
.size bf16_router_decode_wave2_fp32_gfx1151, .Lfunc_end0-bf16_router_decode_wave2_fp32_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: bf16_router_decode_wave2_fp32_gfx1151
