...
//
// Accepted raw gfx1151 group4-A for N64 and N2048 dense-linear prefill with runtime N and K.
...
// grid=(N/64,group_count,1), block=(128,1,1). Four waves share one 4 KiB A tile.
//
...
// 16-row WMMA tiles. The caller pads the final M group to 64 rows.
	...
	.macro PREFILL_ACC_TILE_GROUP4 LDSOFF C0 C1 C2 C3 C4 C5 C6 C7
	...
	.protected mxfp4_sgl_linear_prefill_group4_a_gfx1151
	.globl mxfp4_sgl_linear_prefill_group4_a_gfx1151
	.p2align 8
	.type mxfp4_sgl_linear_prefill_group4_a_gfx1151,@function
mxfp4_sgl_linear_prefill_group4_a_gfx1151:
	s_clause 0x2
...
.Lmxblock:
	...
	PREFILL_ACC_TILE_GROUP4 0    v32 v33 v34 v35 v36 v37 v38 v39
	PREFILL_ACC_TILE_GROUP4 1024 v40 v41 v42 v43 v44 v45 v46 v47
	PREFILL_ACC_TILE_GROUP4 2048 v48 v49 v50 v51 v52 v53 v54 v55
	PREFILL_ACC_TILE_GROUP4 3072 v56 v57 v58 v59 v60 v61 v62 v63
	...
	.p2align 6, 0
	.amdhsa_kernel mxfp4_sgl_linear_prefill_group4_a_gfx1151
	...
	.text
.Lfunc_end0:
	.size mxfp4_sgl_linear_prefill_group4_a_gfx1151, .Lfunc_end0-mxfp4_sgl_linear_prefill_group4_a_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: mxfp4_sgl_linear_prefill_group4_a_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 30
    .sgpr_spill_count: 0
    .symbol: mxfp4_sgl_linear_prefill_group4_a_gfx1151.kd
