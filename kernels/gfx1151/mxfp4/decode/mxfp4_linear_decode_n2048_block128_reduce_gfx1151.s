...
//
// Raw gfx1151 exact-order reduction for fixed N=2048, K=4096 decode.
// partials=[128,N] FP32 and scales=[128,N] E8M0 are reduced in the same
// 128-FMA order as the original kernel, then stored as output=[N] BF16.
// Launch: grid=(16,1,1), block=(128,1,1).
	...
	.protected mxfp4_linear_decode_n2048_block128_reduce_gfx1151
	.globl mxfp4_linear_decode_n2048_block128_reduce_gfx1151
	.p2align 8
	.type mxfp4_linear_decode_n2048_block128_reduce_gfx1151,@function
mxfp4_linear_decode_n2048_block128_reduce_gfx1151:
	s_clause 0x1
	s_load_b128 s[4:7], s[0:1], 0
	s_load_b64 s[8:9], s[0:1], 16
	s_waitcnt lgkmcnt(0)

	// One work-item reproduces the original 128-block FP32 FMA order.
	s_lshl_b32 s14, s2, 7
...
v_fmac_f32_e32 v2, v8, v9
	...
	.p2align 6, 0
	.amdhsa_kernel mxfp4_linear_decode_n2048_block128_reduce_gfx1151
	...
	.text
.Lfunc_end0:
	.size mxfp4_linear_decode_n2048_block128_reduce_gfx1151, .Lfunc_end0-mxfp4_linear_decode_n2048_block128_reduce_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: mxfp4_linear_decode_n2048_block128_reduce_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 24
    .sgpr_spill_count: 0
    .symbol: mxfp4_linear_decode_n2048_block128_reduce_gfx1151.kd
