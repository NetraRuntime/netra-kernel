...
//
// Raw gfx1151 MXFP4 N2048 K4096 block-parallel decode kernel.
// packed=[K/2,N], activation=[K] BF16, and output=[128,N] stores one
// unscaled FP32 contribution per MX block. N/K kernargs preserve the ABI.
// grid=(4,128,1), block=(128,1,1); each lane owns four outputs.
	...
	.protected mxfp4_linear_decode_n2048_k4096_block128_gfx1151
	.globl mxfp4_linear_decode_n2048_k4096_block128_gfx1151
	.p2align 8
	.type mxfp4_linear_decode_n2048_k4096_block128_gfx1151,@function
mxfp4_linear_decode_n2048_k4096_block128_gfx1151:
	s_clause 0x2
	...
	s_add_u32 s4, s4, s18
	s_addc_u32 s5, s5, 0
	s_lshl_b32 s18, s3, 11
	s_add_u32 s6, s6, s18
	s_addc_u32 s7, s7, 0
	s_lshl_b32 s18, s3, 6
	s_add_u32 s8, s8, s18
	s_addc_u32 s9, s9, 0
	s_lshl_b32 s18, s3, 13
...
.Lmxblock:
	...
	.p2align 6, 0
	.amdhsa_kernel mxfp4_linear_decode_n2048_k4096_block128_gfx1151
	...
	.text
.Lfunc_end0:
	.size mxfp4_linear_decode_n2048_k4096_block128_gfx1151, .Lfunc_end0-mxfp4_linear_decode_n2048_k4096_block128_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: mxfp4_linear_decode_n2048_k4096_block128_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 24
    .sgpr_spill_count: 0
    .symbol: mxfp4_linear_decode_n2048_k4096_block128_gfx1151.kd
