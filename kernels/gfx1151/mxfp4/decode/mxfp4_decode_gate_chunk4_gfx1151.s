...
//   scales: [8, K/32, N] E8M0, applied before chunk accumulation
//   a:      [K] bf16
//   y:      [16,8,N] scaled four-MX-block fp32 partials
//
// Launch: grid=(1,128,1), block=(128,1,1). workgroup_id_y encodes
// selected-slot*16 + four-block chunk.
	...
	.protected mxfp4_decode_gate_chunk4_gfx1151
	.globl mxfp4_decode_gate_chunk4_gfx1151
	.p2align 8
	.type mxfp4_decode_gate_chunk4_gfx1151,@function
mxfp4_decode_gate_chunk4_gfx1151:
	...
	// packed += resident_expert*2^19 + chunk*2^15.
	s_lshl_b32 s14, s13, 19
	s_lshl_b32 s15, s12, 15
	s_waitcnt_depctr 0
	...
	// scales += resident_expert*2^15 + chunk*2^11.
	s_lshl_b32 s14, s13, 15
	s_lshl_b32 s15, s12, 11
	s_add_u32 s14, s14, s15
	s_add_u32 s6, s6, s14
	s_addc_u32 s7, s7, 0

	// activation += chunk*256 bytes.
	s_lshl_b32 s14, s12, 8
	s_add_u32 s8, s8, s14
	s_addc_u32 s9, s9, 0

	// output += chunk*16384 + selected-slot*2048 bytes.
...
.Lmxblock:
	...
	// Store one scaled four-block contribution in [chunk,slot,N] FP32.
	...
	.p2align 6, 0
	.amdhsa_kernel mxfp4_decode_gate_chunk4_gfx1151
	...
	.text
.Lfunc_end0:
	.size mxfp4_decode_gate_chunk4_gfx1151, .Lfunc_end0-mxfp4_decode_gate_chunk4_gfx1151
