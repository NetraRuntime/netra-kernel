...
// Raw gfx1151 M12 grouped epilogue for twelve rows per routed group: bf16(silu(gate_f32) * up_f32).

	.amdgcn_target "amdgcn-amd-amdhsa--gfx1151"
	.amdhsa_code_object_version 6
	.text
	.protected silu_mul_m12_group_bf16_gfx1151
	.globl silu_mul_m12_group_bf16_gfx1151
	.p2align 8
	.type silu_mul_m12_group_bf16_gfx1151,@function
silu_mul_m12_group_bf16_gfx1151:
	...
	.p2align 6, 0
	.amdhsa_kernel silu_mul_m12_group_bf16_gfx1151
	...
	.text
.Lfunc_end0:
	.size silu_mul_m12_group_bf16_gfx1151, .Lfunc_end0-silu_mul_m12_group_bf16_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: silu_mul_m12_group_bf16_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 14
    .sgpr_spill_count: 0
    .symbol: silu_mul_m12_group_bf16_gfx1151.kd
