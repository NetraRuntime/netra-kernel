...
//
// Raw gfx1151 M12 routed-group down-projection WMMA specialization.
// Qwen3.6: N=2048, K=512, group storage stride=64 rows.
// Launch grid=(128,group_count,1), block=(32,1,1). Compute/store rows 0..11.
	...
	.protected mxfp4_m12_group_down_wmma_gfx1151
	.globl mxfp4_m12_group_down_wmma_gfx1151
	.p2align 8
	.type mxfp4_m12_group_down_wmma_gfx1151,@function
...
s_lshl_b32 s15, s3, 2
s_waitcnt_depctr 0
s_load_b32 s14, s[12:13], s15
s_waitcnt lgkmcnt(0)
s_lshl_b32 s12, s14, 19
s_lshl_b32 s13, s14, 15
s_lshl_b32 s14, s3, 16
s_lshl_b32 s15, s3, 19
s_waitcnt_depctr 0
s_add_u32 s4, s4, s12
s_addc_u32 s5, s5, 0
s_add_u32 s6, s6, s13
...
.Lmxblock:
	...
	// [group,64,2048] output; subgroup 1 suppresses padded rows 12..15.
	...
	.p2align 6, 0
	.amdhsa_kernel mxfp4_m12_group_down_wmma_gfx1151
...
.amdhsa_kernarg_size 40
	...
	.text
.Lfunc_end0:
	.size mxfp4_m12_group_down_wmma_gfx1151, .Lfunc_end0-mxfp4_m12_group_down_wmma_gfx1151
...
amdhsa.kernels:
  - .args:
      ...
      - { .name: scales, .offset: 8, .size: 8, .value_kind: global_buffer,
          .address_space: global, .actual_access: read_only }
      - { .name: intermediate_groups_m64, .offset: 16, .size: 8,
          .value_kind: global_buffer, .address_space: global,
          .actual_access: read_only }
      - { .name: expert_output_groups_m64, .offset: 24, .size: 8,
          .value_kind: global_buffer, .address_space: global,
    ...
    .name: mxfp4_m12_group_down_wmma_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 23
    .sgpr_spill_count: 0
    .symbol: mxfp4_m12_group_down_wmma_gfx1151.kd
