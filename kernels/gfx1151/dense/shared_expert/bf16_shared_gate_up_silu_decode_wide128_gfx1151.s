...
.protected bf16_shared_gate_up_silu_decode_wide128_gfx1151
.globl bf16_shared_gate_up_silu_decode_wide128_gfx1151
.p2align 8
.type bf16_shared_gate_up_silu_decode_wide128_gfx1151,@function
...
// Each K step covers eight BF16 values per lane. A 128-bit load increases
// in-flight data and quarters address/loop overhead for each output row.
...
global_load_b128 v[22:25], v8, s[4:5]
...
.p2align 6, 0
.amdhsa_kernel bf16_shared_gate_up_silu_decode_wide128_gfx1151
...
.text
.Lfunc_end0:
.size bf16_shared_gate_up_silu_decode_wide128_gfx1151, .Lfunc_end0-bf16_shared_gate_up_silu_decode_wide128_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: bf16_shared_gate_up_silu_decode_wide128_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 16
    .sgpr_spill_count: 0
    .symbol: bf16_shared_gate_up_silu_decode_wide128_gfx1151.kd
