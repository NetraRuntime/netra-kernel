...
//
// Accepted raw gfx1151 BF16 LM-head GEMV.
// Fixed M=1, N=248320, K=2048, row-major physical weights [N,K].
// Each wave32 computes four rows; each workgroup contains eight waves.
// Grid=(7760,1,1), block=(256,1,1).
...
.protected bf16_lm_head_decode_wave4_gfx1151
.globl bf16_lm_head_decode_wave4_gfx1151
.p2align 8
.type bf16_lm_head_decode_wave4_gfx1151,@function
bf16_lm_head_decode_wave4_gfx1151:
// kernarg: weights, activation, output (three stable device pointers).
s_load_b128 s[4:7], s[0:1], 0
s_load_b64 s[8:9], s[0:1], 16
s_waitcnt lgkmcnt(0)

// row = workgroup_id_x*32 + wave_id*4.
...
v_add_nc_u32_e32 v9, 8192, v2
v_add_nc_u32_e32 v16, 12288, v2
...
// One lane per wave stores four consecutive BF16 logits.
v_cmp_eq_u32_e32 vcc_lo, 0, v11
s_and_saveexec_b32 s14, vcc_lo
v_lshlrev_b32_e32 v2, 1, v10
global_store_b64 v2, v[12:13], s[8:9]
s_endpgm

.section .rodata,"a",@progbits
.p2align 6, 0
.amdhsa_kernel bf16_lm_head_decode_wave4_gfx1151
...
.text
.Lfunc_end0:
.size bf16_lm_head_decode_wave4_gfx1151, .Lfunc_end0-bf16_lm_head_decode_wave4_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: bf16_lm_head_decode_wave4_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 16
    .sgpr_spill_count: 0
    .symbol: bf16_lm_head_decode_wave4_gfx1151.kd
