...
// Each wave32 computes one row; each workgroup contains two waves.
// Grid=(124160,1,1), block=(64,1,1).
...
.protected bf16_lm_head_decode_wave1_wg64_gfx1151
.globl bf16_lm_head_decode_wave1_wg64_gfx1151
.p2align 8
.type bf16_lm_head_decode_wave1_wg64_gfx1151,@function
bf16_lm_head_decode_wave1_wg64_gfx1151:
// kernarg: weights, activation, output (three stable device pointers).
s_load_b128 s[4:7], s[0:1], 0
s_load_b64 s[8:9], s[0:1], 16
s_waitcnt lgkmcnt(0)

// row = workgroup_id_x*2 + wave_id.
v_lshrrev_b32_e32 v10, 5, v0
s_lshl_b32 s10, s2, 1
v_add_nc_u32_e32 v10, s10, v10

// One output row per wave; each K load remains a coalesced 128-byte line.
...
.p2align 6, 0
.amdhsa_kernel bf16_lm_head_decode_wave1_wg64_gfx1151
...
.text
.Lfunc_end0:
.size bf16_lm_head_decode_wave1_wg64_gfx1151, .Lfunc_end0-bf16_lm_head_decode_wave1_wg64_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: bf16_lm_head_decode_wave1_wg64_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 16
    .sgpr_spill_count: 0
    .symbol: bf16_lm_head_decode_wave1_wg64_gfx1151.kd
