...
// Raw gfx1151 Qwen3.6 extend attention: M64 x N32, 20 KiB LDS.
...
.protected extend_attention_wmma_n32_gfx1151
.globl extend_attention_wmma_n32_gfx1151
.p2align 8
.type extend_attention_wmma_n32_gfx1151,@function
extend_attention_wmma_n32_gfx1151:
  s_clause 0x3
  ...
  // Direct Q address is L2-reloaded per N tile to keep LDS at 20 KiB.
  ...
  // C-layout row base and 4 KiB P transpose workspace after 16 KiB data LDS.
...
.Lk_loaded:
  ...
  .set DK, 0
  .rept 16
    global_load_b128 v[8:11], v221, s[4:5] offset:(DK*32)
    s_waitcnt vmcnt(0)
...
.p2align 6, 0
.amdhsa_kernel extend_attention_wmma_n32_gfx1151
...
.text
.Lfunc_end0:
.size extend_attention_wmma_n32_gfx1151, .Lfunc_end0-extend_attention_wmma_n32_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: extend_attention_wmma_n32_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 48
    .sgpr_spill_count: 0
    .symbol: extend_attention_wmma_n32_gfx1151.kd
