...
// Experimental kvbatch16-softpipe: issue all row exponentials before unchanged online-softmax reductions. Grid=(M/64,4,1), block=512.
...
.protected extend_attention_wmma_n64_group4_qpipe_kvbatch16_softpipe_gfx1151
.globl extend_attention_wmma_n64_group4_qpipe_kvbatch16_softpipe_gfx1151
.p2align 8
.type extend_attention_wmma_n64_group4_qpipe_kvbatch16_softpipe_gfx1151,@function
extend_attention_wmma_n64_group4_qpipe_kvbatch16_softpipe_gfx1151:
...
.Lmask_done:
  ...
  // Delay all v_exp consumers until exponentials for every output row issue.
  .set SR, 0
  .rept 8
    v_mov_b32_e32 v[216+SR], v[24+SR]
...
.p2align 6, 0
.amdhsa_kernel extend_attention_wmma_n64_group4_qpipe_kvbatch16_softpipe_gfx1151
...
.text
.Lfunc_end0:
.size extend_attention_wmma_n64_group4_qpipe_kvbatch16_softpipe_gfx1151, .Lfunc_end0-extend_attention_wmma_n64_group4_qpipe_kvbatch16_softpipe_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: extend_attention_wmma_n64_group4_qpipe_kvbatch16_softpipe_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 64
    .sgpr_spill_count: 0
    .symbol: extend_attention_wmma_n64_group4_qpipe_kvbatch16_softpipe_gfx1151.kd
