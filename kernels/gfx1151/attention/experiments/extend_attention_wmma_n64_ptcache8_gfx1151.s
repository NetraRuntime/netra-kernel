...
// Reuse the second eight prefix page-table entries left live by the K phase.
...
.protected extend_attention_wmma_n64_ptcache8_gfx1151
.globl extend_attention_wmma_n64_ptcache8_gfx1151
.p2align 8
.type extend_attention_wmma_n64_ptcache8_gfx1151,@function
...
.Lmask_done:
  ...
  LOAD_PREFIX_BATCH8_REUSE 32, 14
  LOAD_PREFIX_BATCH8 0, 14
  s_branch .Lv_loaded
.Lload_v_current:
  LOAD_CURRENT_64 8
.Lv_loaded:
...
.p2align 6, 0
.amdhsa_kernel extend_attention_wmma_n64_ptcache8_gfx1151
...
.text
.Lfunc_end0:
.size extend_attention_wmma_n64_ptcache8_gfx1151, .Lfunc_end0-extend_attention_wmma_n64_ptcache8_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: extend_attention_wmma_n64_ptcache8_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 48
    .sgpr_spill_count: 0
    .symbol: extend_attention_wmma_n64_ptcache8_gfx1151.kd
