...
// Reuse the first eight prefix page-table entries left live by the K phase.
// s44:s59 are untouched by QK, masking, and online softmax.
.macro LOAD_PREFIX_BATCH8_REUSE KOFF PTR
  .set BI, 0
  .rept 8
    s_lshl_b32 s38, s[44+BI*2], 10
    s_add_u32 s38, s38, s25
...
.protected extend_attention_wmma_n64_ptcache8_first_gfx1151
.globl extend_attention_wmma_n64_ptcache8_first_gfx1151
.p2align 8
.type extend_attention_wmma_n64_ptcache8_first_gfx1151,@function
...
.Lmask_done:
  ...
  LOAD_PREFIX_BATCH8_REUSE 0, 14
  LOAD_PREFIX_BATCH8 32, 14
  s_branch .Lv_loaded
.Lload_v_current:
  LOAD_CURRENT_64 8
.Lv_loaded:
...
.p2align 6, 0
.amdhsa_kernel extend_attention_wmma_n64_ptcache8_first_gfx1151
...
.text
.Lfunc_end0:
.size extend_attention_wmma_n64_ptcache8_first_gfx1151, .Lfunc_end0-extend_attention_wmma_n64_ptcache8_first_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: extend_attention_wmma_n64_ptcache8_first_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 48
    .sgpr_spill_count: 0
    .symbol: extend_attention_wmma_n64_ptcache8_first_gfx1151.kd
