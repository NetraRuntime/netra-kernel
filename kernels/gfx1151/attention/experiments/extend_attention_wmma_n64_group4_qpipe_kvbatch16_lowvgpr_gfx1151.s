...
.macro RESTORE_Q_P_ADDRS
  ...
  v_lshl_add_u32 v8, v2, 11, v8
  v_lshl_add_u32 v13, v4, 7, v8
  v_lshl_add_u32 v13, v3, 1, v13
  v_lshl_add_u32 v10, v3, 7, v8
...
// exposes memory-level parallelism while keeping all temporary registers below v224.
.macro LOAD_Q_PIPE8
  .set QP, 0
  .rept 2
    .set QI, 0
...
.protected extend_attention_wmma_n64_group4_qpipe_kvbatch16_lowvgpr_gfx1151
.globl extend_attention_wmma_n64_group4_qpipe_kvbatch16_lowvgpr_gfx1151
.p2align 8
.type extend_attention_wmma_n64_group4_qpipe_kvbatch16_lowvgpr_gfx1151,@function
extend_attention_wmma_n64_group4_qpipe_kvbatch16_lowvgpr_gfx1151:
...
.Lk_loaded:
  ...
  .rept 16
    ...
    v_add_nc_u32_e32 v0, (32768+DK*32), v0
    SWIZZLE_K_LDS_READ
    ...
    .rept 4
      .if KT < 3
        v_lshlrev_b32_e32 v0, 9, v3
        v_lshl_add_u32 v0, v4, 4, v0
        v_add_nc_u32_e32 v0, (32768+(KT+1)*8192+DK*32), v0
        SWIZZLE_K_LDS_READ
        .if (KT % 2) == 0
...
.Lmask_done:
  ...
  .rept 4
    ...
    .rept 8
      ...
      ds_write_b16 v13, v12 offset:(PT*32+PR*256)
      .set PR, PR+1
    .endr
    .set PT, PT+1
  .endr
...
.Lv_loaded:
  ...
  // Preserve the P LDS read address before v8:v11 becomes the load destination.
  v_mov_b32_e32 v5, v10
  .set VT, 0
  .rept 4
    ds_load_b128 v[8:11], v5 offset:(VT*32)
    s_waitcnt lgkmcnt(0)
    ds_swizzle_b32 v12, v8 offset:swizzle(SWAP,16)
    ds_swizzle_b32 v13, v9 offset:swizzle(SWAP,16)
    ds_swizzle_b32 v14, v10 offset:swizzle(SWAP,16)
    ...
    v_add_nc_u32_e32 v0, (32768+VT*8192), v0
    .set OB, 0
    ...
    .rept 16
      ...
      .else
        ...
        .endif
        v_wmma_f32_16x16x16_bf16 v[64+OB*8:71+OB*8], v[8:15], v[56:63], v[64+OB*8:71+OB*8]
        .if OB < 15
          s_waitcnt lgkmcnt(0)
          ds_swizzle_b32 v20, v16 offset:swizzle(SWAP,16)
          ds_swizzle_b32 v21, v17 offset:swizzle(SWAP,16)
...
.p2align 6, 0
.amdhsa_kernel extend_attention_wmma_n64_group4_qpipe_kvbatch16_lowvgpr_gfx1151
...
.text
.Lfunc_end0:
.size extend_attention_wmma_n64_group4_qpipe_kvbatch16_lowvgpr_gfx1151, .Lfunc_end0-extend_attention_wmma_n64_group4_qpipe_kvbatch16_lowvgpr_gfx1151
...
amdhsa.kernels:
  - .args:
    ...
    .name: extend_attention_wmma_n64_group4_qpipe_kvbatch16_lowvgpr_gfx1151
    .private_segment_fixed_size: 0
    .sgpr_count: 64
    .sgpr_spill_count: 0
    .symbol: extend_attention_wmma_n64_group4_qpipe_kvbatch16_lowvgpr_gfx1151.kd
