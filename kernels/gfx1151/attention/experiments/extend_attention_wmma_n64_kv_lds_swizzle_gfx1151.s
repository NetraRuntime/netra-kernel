...
// Experimental M64 x N64 K+V LDS-bank swizzle for gfx1151.
...
// K XOR-permutes 16-byte chunks by row[2:0]. V XOR-permutes the
// 64-byte column group by row[3], separating the two V row halves in LDS.
// Both transformations are self-inverse when applied to the read address.
.macro SWIZZLE_KV_LDS_WRITE PTR
  .if \PTR == 6
...
.Lv_loaded:
  ...
  .rept 4
    ...
    v_lshlrev_b32_e32 v236, 6, v4
    .set OB, 0
    v_xor_b32_e32 v235, v236, v234
    ds_load_u16 v16, v235 offset:0
    ds_load_u16_d16_hi v16, v235 offset:512
    ds_load_u16 v17, v235 offset:1024
    ds_load_u16_d16_hi v17, v235 offset:1536
    ds_load_u16 v18, v235 offset:2048
    ds_load_u16_d16_hi v18, v235 offset:2560
    ds_load_u16 v19, v235 offset:3072
    ds_load_u16_d16_hi v19, v235 offset:3584
    s_waitcnt lgkmcnt(0)
    ds_swizzle_b32 v20, v16 offset:swizzle(SWAP,16)
    ds_swizzle_b32 v21, v17 offset:swizzle(SWAP,16)
    ds_swizzle_b32 v22, v18 offset:swizzle(SWAP,16)
    ...
    .rept 16
      .if (OB % 2) == 0
        .if OB < 15
          v_add_nc_u32_e32 v235, ((OB+1)*32), v234
          v_xor_b32_e32 v235, v236, v235
          ds_load_u16 v225, v235 offset:0
          ds_load_u16_d16_hi v225, v235 offset:512
          ds_load_u16 v226, v235 offset:1024
          ds_load_u16_d16_hi v226, v235 offset:1536
          ds_load_u16 v227, v235 offset:2048
          ds_load_u16_d16_hi v227, v235 offset:2560
          ds_load_u16 v228, v235 offset:3072
          ds_load_u16_d16_hi v228, v235 offset:3584
        .endif
