...
// family T=12, H=16, HV=32, K=128, B=1..64.
//
// Grid: B*192 one-wave workgroups. workgroup_x = global_token * 16 + q_head.
...
// decoder's BF16 beta boundary. Variant 8 is the production selection.
	...
	.protected qwen36_gdn_verify_m12_batched_precompute_gfx950
	.globl qwen36_gdn_verify_m12_batched_precompute_gfx950
	.p2align 8
	.type qwen36_gdn_verify_m12_batched_precompute_gfx950,@function
...
.Lgate_done:
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_gdn_verify_m12_batched_precompute_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_gdn_verify_m12_batched_precompute_gfx950, .Lfunc_end0-qwen36_gdn_verify_m12_batched_precompute_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_gdn_verify_m12_batched_precompute_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 48
    .sgpr_spill_count: 0
    .symbol: qwen36_gdn_verify_m12_batched_precompute_gfx950.kd
