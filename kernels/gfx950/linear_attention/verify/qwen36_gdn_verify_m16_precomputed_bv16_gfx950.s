...
// registers).  K/Q vectors are cooperatively staged through 1 KiB LDS.
	...
	.globl qwen36_gdn_verify_m16_precomputed_bv16_gfx950
	.p2align 8
	.type qwen36_gdn_verify_m16_precomputed_bv16_gfx950,@function
qwen36_gdn_verify_m16_precomputed_bv16_gfx950:
	...
	// B=1 exact verify shape. Resolve the selected recurrent-state pool slot
	// (1 MiB each) and intermediate-state slot (16 cached steps = 16 MiB).
	s_load_dword s24, s[24:25], 0
	s_load_dword s26, s[26:27], 0
	s_waitcnt lgkmcnt(0)
	s_mov_b32 s25, 0
...
.Ladvance:
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_gdn_verify_m16_precomputed_bv16_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_gdn_verify_m16_precomputed_bv16_gfx950, .Lfunc_end0-qwen36_gdn_verify_m16_precomputed_bv16_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_gdn_verify_m16_precomputed_bv16_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 40
    .sgpr_spill_count: 0
    .symbol: qwen36_gdn_verify_m16_precomputed_bv16_gfx950.kd
