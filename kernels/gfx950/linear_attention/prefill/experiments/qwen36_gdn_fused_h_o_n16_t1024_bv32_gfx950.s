...
// B16/T16384 (16x1024)/H32/Hg16/K128/V128/BT64/BV32, wave64.
// Grid=(4,512,1), block=(256,1,1), LDS=24576 bytes.
//
// One workgroup owns a (head,V32) recurrent-state tile and walks its 16
...
// is shared by both V16 halves, halving redundant QK work per head. Prefix-state
// emission is intentionally absent in this isolated experiment.
	...
	.protected qwen36_gdn_fused_h_o_n16_t1024_bv32_gfx950
	.globl qwen36_gdn_fused_h_o_n16_t1024_bv32_gfx950
	.p2align 8
	.type qwen36_gdn_fused_h_o_n16_t1024_bv32_gfx950,@function
qwen36_gdn_fused_h_o_n16_t1024_bv32_gfx950:
	...
	s_lshl_b32 s33, s2, 6
	s_add_u32 s33, s33, s32             // u/o head + V32 base
	s_lshl_b32 s34, s35, 2               // gate head base
	s_lshl_b32 s26, s35, 15
	s_lshl_b32 s27, s2, 13
	s_add_u32 s26, s26, s27             // state head + V32 base
...
.Lkeep_segment_state:
	.endif
	// Make the current FP32 state available as BF16 [V32,K128] in LDS.
...
.Lqk_loop:
	...
	// Scale and write the V32 output tile.
	...
	STATE_UPDATE 0, 0, 64, 20480
	STATE_UPDATE 1, 0, 68, 20480
	STATE_UPDATE 0, 1, 64, 20480
	STATE_UPDATE 1, 1, 68, 20480
	STATE_UPDATE 0, 0, 120, 22528
	STATE_UPDATE 1, 0, 124, 22528
	STATE_UPDATE 0, 1, 120, 22528
	STATE_UPDATE 1, 1, 124, 22528
	s_nop 8
	s_barrier
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_gdn_fused_h_o_n16_t1024_bv32_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_gdn_fused_h_o_n16_t1024_bv32_gfx950, .Lfunc_end0-qwen36_gdn_fused_h_o_n16_t1024_bv32_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_gdn_fused_h_o_n16_t1024_bv32_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 36
    .sgpr_spill_count: 0
    .symbol: qwen36_gdn_fused_h_o_n16_t1024_bv32_gfx950.kd
