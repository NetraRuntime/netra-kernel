...
// B16/T16384 (16x1024)/H32/Hg16/K128/V128/BT64/BV64, wave64.
// Grid=(2,512,1), block=(256,1,1), LDS=40960 bytes.
//
// One workgroup owns a (head,V64) recurrent-state tile and walks its 16
...
// is shared by four V16 quarters, reducing redundant QK work fourfold per head. Prefix-state
// emission is intentionally absent in this isolated experiment.
	...
	.protected qwen36_gdn_fused_h_o_n16_t1024_bv64_gfx950
	.globl qwen36_gdn_fused_h_o_n16_t1024_bv64_gfx950
	.p2align 8
	.type qwen36_gdn_fused_h_o_n16_t1024_bv64_gfx950,@function
qwen36_gdn_fused_h_o_n16_t1024_bv64_gfx950:
	...
	s_lshl_b32 s33, s2, 7
	s_add_u32 s33, s33, s32             // u/o head + V64 base
	s_lshl_b32 s34, s35, 2               // gate head base
	s_lshl_b32 s26, s35, 15
	s_lshl_b32 s27, s2, 14
	s_add_u32 s26, s26, s27             // state head + V64 base
	// Fixed 1024-token per-sequence strides: q/k=4 MiB, u/w/o=8 MiB,
	// g=128 KiB, and recurrent state=1 MiB.
	s_lshl_b32 s27, s28, 22
	s_add_u32 s31, s31, s27
	s_lshl_b32 s27, s28, 23
	s_add_u32 s32, s32, s27
	s_add_u32 s33, s33, s27
	s_lshl_b32 s27, s28, 17
	s_add_u32 s34, s34, s27
	s_lshl_b32 s27, s28, 20
...
.Lkeep_segment_state:
	.endif
	// Make the current FP32 state available as BF16 [V64,K128] in LDS.
...
.Lqk_loop:
	...
	// Scale and write the V64 output tile.
	...
	// Load g_last and create BF16 exp(g_last-g)*v_new at LDS+32768.
	...
	STATE_UPDATE 0, 0, 64, 32768
	STATE_UPDATE 1, 0, 68, 32768
	STATE_UPDATE 0, 1, 64, 32768
	STATE_UPDATE 1, 1, 68, 32768
	STATE_UPDATE 0, 0, 120, 34816
	STATE_UPDATE 1, 0, 124, 34816
	STATE_UPDATE 0, 1, 120, 34816
	STATE_UPDATE 1, 1, 124, 34816
	STATE_UPDATE 0, 0, 144, 36864
	STATE_UPDATE 1, 0, 148, 36864
	STATE_UPDATE 0, 1, 144, 36864
	STATE_UPDATE 1, 1, 148, 36864
	STATE_UPDATE 0, 0, 152, 38912
	STATE_UPDATE 1, 0, 156, 38912
	STATE_UPDATE 0, 1, 152, 38912
	STATE_UPDATE 1, 1, 156, 38912
	s_nop 8
	s_barrier
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_gdn_fused_h_o_n16_t1024_bv64_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_gdn_fused_h_o_n16_t1024_bv64_gfx950, .Lfunc_end0-qwen36_gdn_fused_h_o_n16_t1024_bv64_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_gdn_fused_h_o_n16_t1024_bv64_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 36
    .sgpr_spill_count: 0
    .symbol: qwen36_gdn_fused_h_o_n16_t1024_bv64_gfx950.kd
