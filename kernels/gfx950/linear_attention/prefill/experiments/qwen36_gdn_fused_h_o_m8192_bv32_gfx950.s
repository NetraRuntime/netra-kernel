...
// B1/T8192/H32/Hg16/K128/V128/BT64/BV32, wave64.
// Grid=(4,32,1), block=(256,1,1), LDS=24576 bytes.
//
// One workgroup owns a (head,V32) recurrent-state tile and walks all 128
...
// emission is intentionally absent in this isolated experiment.
	...
	.protected qwen36_gdn_fused_h_o_m8192_bv32_gfx950
	.globl qwen36_gdn_fused_h_o_m8192_bv32_gfx950
	.p2align 8
	.type qwen36_gdn_fused_h_o_m8192_bv32_gfx950,@function
qwen36_gdn_fused_h_o_m8192_bv32_gfx950:
...
.Lqk_loop:
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_gdn_fused_h_o_m8192_bv32_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_gdn_fused_h_o_m8192_bv32_gfx950, .Lfunc_end0-qwen36_gdn_fused_h_o_m8192_bv32_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_gdn_fused_h_o_m8192_bv32_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 36
    .sgpr_spill_count: 0
    .symbol: qwen36_gdn_fused_h_o_m8192_bv32_gfx950.kd
