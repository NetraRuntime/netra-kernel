...
//
// Eight wave64s compute a 64x128 output macro tile. Each wave owns one 32x32
...
// pitch while preserving vector reads.
	...
	.text
	.protected qwen36_dflash_mlp_gateup_bf16_m768_m64n128_lds128_gfx950
	.globl qwen36_dflash_mlp_gateup_bf16_m768_m64n128_lds128_gfx950
	.p2align 8
	.type qwen36_dflash_mlp_gateup_bf16_m768_m64n128_lds128_gfx950,@function
qwen36_dflash_mlp_gateup_bf16_m768_m64n128_lds128_gfx950:
	...
	s_lshl_b32 s21, s12, 7       // workgroup col base
	...
	// All 512 threads stage A: eight threads per row, two vectors each.
	...
	// Four threads per B row stage the 128-column macro tile.
	...
	v_add_u32_e32 v10, v10, v58

	// Cooperative LDS write offsets. A has 64 rows and B has 128 rows.
	v_mul_lo_u32 v48, v7, s22
	v_add_u32_e32 v48, v48, v12
	v_mul_lo_u32 v49, v57, s22
	v_add_u32_e32 v49, v49, v58
	v_add_u32_e32 v49, LDS_A_BYTES, v49
...
.Lk128_stage_loop:
	...
	global_load_dwordx4 v[20:23], v8, s[4:5] offset:128
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_dflash_mlp_gateup_bf16_m768_m64n128_lds128_gfx950
		// Reserve pitch 320 for 64 A rows plus 128 B rows.
	...
	.text
.Lfunc_end0:
	.size qwen36_dflash_mlp_gateup_bf16_m768_m64n128_lds128_gfx950, .Lfunc_end0-qwen36_dflash_mlp_gateup_bf16_m768_m64n128_lds128_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_dflash_mlp_gateup_bf16_m768_m64n128_lds128_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 24
    .sgpr_spill_count: 0
    .symbol: qwen36_dflash_mlp_gateup_bf16_m768_m64n128_lds128_gfx950.kd
