...
//
// Four independent wave64s per workgroup compute four adjacent 16-column
// tiles. This matches CK's 192-workgroup/4-wave launch topology without LDS,
// barriers, or cross-wave reduction. The deployed AITER 16x16 preshuffle is
// consumed directly.

	.amdgcn_target "amdgcn-amd-amdhsa--gfx950"
	.amdhsa_code_object_version 6
	.text
	.protected qwen36_dense_m1_n12288_k2048_fp8_mfma_4wave_gfx950
	.globl qwen36_dense_m1_n12288_k2048_fp8_mfma_4wave_gfx950
	.p2align 8
	.type qwen36_dense_m1_n12288_k2048_fp8_mfma_4wave_gfx950,@function
qwen36_dense_m1_n12288_k2048_fp8_mfma_4wave_gfx950:
	...
	// tile = workgroup*4 + wave, column = tile*16 + lane%16.
	...
	v_lshlrev_b32_e32 v5, 15, v30
	v_add_u32_e32 v4, v5, v4

	// A workgroup spans four tiles, so workgroups 2i and 2i+1 share one
	// 128-column scale row. All four waves therefore use one scalar address.
	s_lshr_b32 s20, s2, 1
...
.Lkblock:
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_dense_m1_n12288_k2048_fp8_mfma_4wave_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_dense_m1_n12288_k2048_fp8_mfma_4wave_gfx950, .Lfunc_end0-qwen36_dense_m1_n12288_k2048_fp8_mfma_4wave_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_dense_m1_n12288_k2048_fp8_mfma_4wave_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 32
    .sgpr_spill_count: 0
    .symbol: qwen36_dense_m1_n12288_k2048_fp8_mfma_4wave_gfx950.kd
