...
//
// Grid: (N/32, ceil(M/32), 1), block: (64, 1, 1).
...
// barriers, split-K, scratch, or atomics.
	...
	.text
	.protected qwen36_dense_m210_n12288_k2048_fp8_mfma_m32n32_gfx950
	.globl qwen36_dense_m210_n12288_k2048_fp8_mfma_m32n32_gfx950
	.p2align 8
	.type qwen36_dense_m210_n12288_k2048_fp8_mfma_m32n32_gfx950,@function
qwen36_dense_m210_n12288_k2048_fp8_mfma_m32n32_gfx950:
...
.Lstore_full:
	...
	v_add_u32_e32 v7, 24576, v104
	global_store_short v7, v75, s[12:13]
	v_add_u32_e32 v7, 49152, v104
	global_store_short v7, v74, s[12:13]
	v_add_u32_e32 v7, 73728, v104
	global_store_short v7, v76, s[12:13]
	...
	v_add_u32_e32 v7, 24576, v105
	global_store_short v7, v75, s[12:13]
	v_add_u32_e32 v7, 49152, v105
	global_store_short v7, v74, s[12:13]
	v_add_u32_e32 v7, 73728, v105
	global_store_short v7, v76, s[12:13]
	s_waitcnt vmcnt(0)
	s_endpgm
...
.Lstore_tail:
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_dense_m210_n12288_k2048_fp8_mfma_m32n32_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_dense_m210_n12288_k2048_fp8_mfma_m32n32_gfx950, .Lfunc_end0-qwen36_dense_m210_n12288_k2048_fp8_mfma_m32n32_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_dense_m210_n12288_k2048_fp8_mfma_m32n32_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 30
    .sgpr_spill_count: 0
    .symbol: qwen36_dense_m210_n12288_k2048_fp8_mfma_m32n32_gfx950.kd
