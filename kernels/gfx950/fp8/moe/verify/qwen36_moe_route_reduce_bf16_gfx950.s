...
//
// The grouped down-projection kernel writes one unweighted BF16 partial for
...
// Shape: partials [rows, 9, 2048] BF16, weights [rows, 9] FP32,
//        output [rows, 2048] BF16.

	.amdgcn_target "amdgcn-amd-amdhsa--gfx950"
	.amdhsa_code_object_version 6
	.text
	.protected qwen36_moe_route_reduce_bf16_gfx950
	.globl qwen36_moe_route_reduce_bf16_gfx950
	.p2align 8
	.type qwen36_moe_route_reduce_bf16_gfx950,@function
qwen36_moe_route_reduce_bf16_gfx950:
	// Kernargs: partial_bf16, topk_weights_f32, output_bf16.
	...
	// A route plane is 2048 BF16 values = 4096 bytes.  Issue all route
	...
	// Zero-extended BF16 payloads become exact FP32 values by moving each
	// 16-bit payload into the upper half of the FP32 bit pattern.
	.irp r,3,4,5,6,7,8,9,10,11
	v_lshlrev_b32_e32 v\r, 16, v\r
	.endr
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_moe_route_reduce_bf16_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_moe_route_reduce_bf16_gfx950, .Lfunc_end0-qwen36_moe_route_reduce_bf16_gfx950
...
amdhsa.kernels:
  - .agpr_count:     0
    ...
    .name: qwen36_moe_route_reduce_bf16_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 22
    .sgpr_spill_count: 0
    .symbol: qwen36_moe_route_reduce_bf16_gfx950.kd
    .vgpr_count: 16
    .vgpr_spill_count: 0
    .wavefront_size: 64
