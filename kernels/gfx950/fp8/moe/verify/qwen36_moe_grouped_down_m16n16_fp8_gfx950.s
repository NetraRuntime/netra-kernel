...
//
// One wave64 computes a 16x16 output tile for one expert-sorted route block.
...
// the nine router weights and reduces to the final BF16 token output.  This
// design reuses each expert weight tile across sixteen routes and contains no
// atomics.
//
// Grid: (128 output tiles, sorted_token_ids.size()/16 blocks, 1)
// Workgroup: (64, 1, 1), wave64.

	.amdgcn_target "amdgcn-amd-amdhsa--gfx950"
	.amdhsa_code_object_version 6
	.text
	.protected qwen36_moe_grouped_down_m16n16_fp8_gfx950
	.globl qwen36_moe_grouped_down_m16n16_fp8_gfx950
	.p2align 8
	.type qwen36_moe_grouped_down_m16n16_fp8_gfx950,@function
qwen36_moe_grouped_down_m16n16_fp8_gfx950:
	// Preserve grid coordinates before loading kernargs.
	s_mov_b32 s40, s2
	s_mov_b32 s41, s3
	...
	s_lshl_b32 s30, s40, 4
	s_lshl_b32 s36, s40, 13
...
.Lend:
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_moe_grouped_down_m16n16_fp8_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_moe_grouped_down_m16n16_fp8_gfx950, .Lfunc_end0-qwen36_moe_grouped_down_m16n16_fp8_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_moe_grouped_down_m16n16_fp8_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 46
    .sgpr_spill_count: 0
    .symbol: qwen36_moe_grouped_down_m16n16_fp8_gfx950.kd
