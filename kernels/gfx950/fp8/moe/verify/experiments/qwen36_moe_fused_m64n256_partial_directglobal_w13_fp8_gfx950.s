...
// output variant derived from the retained 2026-08-08 late-A pipeline.
// W13 fragments stream directly from global memory in each wave, eliminating
// the LDS write/read round trip and two workgroup barriers per K slab. One
// workgroup owns a complete
...
.L_0274:
	...
	s_mov_b32 s38, 0
	// A fragments and scales for slab zero are primed before the loop.
...
.L_dbuf_primed:
.L_0358:
	// Four waves read the same two 1 KiB fragments per output tile. L2
	// supplies the short-window duplicate reads without an LDS round trip.
	s_lshl_b32 s39, s38, 11
	v_add_u32_e32 v95, v2, v1
	v_lshlrev_b32_e32 v95, 4, v95
	v_add_u32_e32 v95, s39, v95
	s_add_u32 s38, s38, 1
	s_cmp_eq_u64 s[66:67], 0
	s_cbranch_scc1 .L_064c
	global_load_dwordx4 v[16:19], v95, s[36:37]
	global_load_dwordx4 v[20:23], v95, s[36:37] offset:1024
	global_load_dwordx4 v[24:27], v95, s[40:41]
	global_load_dwordx4 v[28:31], v95, s[40:41] offset:1024
	global_load_dwordx4 v[32:35], v95, s[42:43]
	global_load_dwordx4 v[36:39], v95, s[42:43] offset:1024
	global_load_dwordx4 v[40:43], v95, s[44:45]
	global_load_dwordx4 v[44:47], v95, s[44:45] offset:1024
