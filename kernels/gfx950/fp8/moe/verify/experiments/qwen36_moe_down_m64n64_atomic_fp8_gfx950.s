...
// apply route weights, and accumulate directly into FP32 token output.
// Grid: (32 N64 tiles, num_valid_ids/64, 1), workgroup: 256, LDS: 8 KiB.

	.amdgcn_target "amdgcn-amd-amdhsa--gfx950"
	.amdhsa_code_object_version 6
	.text
	.protected qwen36_moe_down_m64n64_atomic_fp8_gfx950
	.globl qwen36_moe_down_m64n64_atomic_fp8_gfx950
	.p2align 8
	.type qwen36_moe_down_m64n64_atomic_fp8_gfx950,@function
qwen36_moe_down_m64n64_atomic_fp8_gfx950:
	// route FP8/scales, shuffled W2/scales, sorted IDs/weights/experts,
	// valid count, FP32 token output, rows.
...
.Lk_loop:
	...
	// Apply router weights once and atomically accumulate FP32 token output.
	...
	// Base addresses for four token rows and this N64 group's first column.
	v_lshlrev_b32_e32 v112, 13, v88
	v_lshlrev_b32_e32 v113, 13, v89
	v_lshlrev_b32_e32 v114, 13, v90
	v_lshlrev_b32_e32 v115, 13, v91
	...
	global_atomic_add_f32 v118, v\a0, s[20:21]
	global_atomic_add_f32 v119, v\a1, s[20:21]
	global_atomic_add_f32 v120, v\a2, s[20:21]
	global_atomic_add_f32 v121, v\a3, s[20:21]
	.endm
	ATOMIC_TILE 64,65,66,67,0
	ATOMIC_TILE 68,69,70,71,64
	ATOMIC_TILE 72,73,74,75,128
	ATOMIC_TILE 76,77,78,79,192
	s_waitcnt vmcnt(0)
.Lend:
	s_endpgm
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_moe_down_m64n64_atomic_fp8_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_moe_down_m64n64_atomic_fp8_gfx950, .Lfunc_end0-qwen36_moe_down_m64n64_atomic_fp8_gfx950
...
amdhsa.kernels:
  - .args:
      ...
      - { .name: output_f32, .offset: 64, .size: 8, .value_kind: global_buffer, .address_space: global, .actual_access: read_write }
    ...
    .name: qwen36_moe_down_m64n64_atomic_fp8_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 48
    .sgpr_spill_count: 0
    .symbol: qwen36_moe_down_m64n64_atomic_fp8_gfx950.kd
