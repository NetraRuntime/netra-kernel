...
// Waves with no real route still cooperate in weight loading and every LDS
// barrier, but skip activation/scales, LDS reads, MFMA, and accumulation.
// Grid: (32 N64 tiles, num_valid_ids/64, 1), workgroup: 256, LDS: 8 KiB.

	.amdgcn_target "amdgcn-amd-amdhsa--gfx950"
	.amdhsa_code_object_version 6
	.text
	.protected qwen36_moe_down_m64n64_partial_wave_skip_fp8_gfx950
	.globl qwen36_moe_down_m64n64_partial_wave_skip_fp8_gfx950
	.p2align 8
	.type qwen36_moe_down_m64n64_partial_wave_skip_fp8_gfx950,@function
qwen36_moe_down_m64n64_partial_wave_skip_fp8_gfx950:
	...
	// v4 repeats the wave's sixteen sorted rows across the four lane banks.
	// Preserve an SGPR pair indicating whether this wave has any real route.
	v_lshrrev_b32_e32 v6, 24, v4
	v_and_b32_e32 v7, 0x00ffffff, v4
	v_cmp_gt_u32_e64 s[46:47], 9, v6
	v_cmp_gt_u32_e64 s[48:49], s22, v7
...
.Lend:
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_moe_down_m64n64_partial_wave_skip_fp8_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_moe_down_m64n64_partial_wave_skip_fp8_gfx950, .Lfunc_end0-qwen36_moe_down_m64n64_partial_wave_skip_fp8_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_moe_down_m64n64_partial_wave_skip_fp8_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 52
    .sgpr_spill_count: 0
    .symbol: qwen36_moe_down_m64n64_partial_wave_skip_fp8_gfx950.kd
