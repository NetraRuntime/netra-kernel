...
// write deterministic FP16 route partials for an FP32 fixed-order reducer.
...
// Grid: (32 N64 tiles, num_valid_ids/64, 1), workgroup: 256, LDS: 8 KiB.
	...
	.text
	.protected qwen36_moe_down_m64n64_partial_f16_fp8_gfx950
	.globl qwen36_moe_down_m64n64_partial_f16_fp8_gfx950
	.p2align 8
	.type qwen36_moe_down_m64n64_partial_f16_fp8_gfx950,@function
qwen36_moe_down_m64n64_partial_f16_fp8_gfx950:
	// route FP8/scales, shuffled W2/scales, sorted IDs/weights/experts,
	// valid count, FP16 route-partial workspace, rows.
	...
	// Padding routes use unique sink rows after rows*9; the reducer ignores
	// them. This avoids divergent VMEM stores and cross-workgroup races.
	s_mul_i32 s39, s22, 9
	v_add_u32_e32 v112, s39, v104
	v_add_u32_e32 v113, s39, v105
	v_add_u32_e32 v114, s39, v106
	v_add_u32_e32 v115, s39, v107
	v_lshrrev_b32_e32 v6, 24, v84
	v_cmp_gt_u32_e32 vcc, 9, v6
	v_cndmask_b32_e32 v92, v112, v92, vcc
	v_lshrrev_b32_e32 v6, 24, v85
	v_cmp_gt_u32_e32 vcc, 9, v6
	v_cndmask_b32_e32 v93, v113, v93, vcc
	v_lshrrev_b32_e32 v6, 24, v86
	v_cmp_gt_u32_e32 vcc, 9, v6
	v_cndmask_b32_e32 v94, v114, v94, vcc
	v_lshrrev_b32_e32 v6, 24, v87
	v_cmp_gt_u32_e32 vcc, 9, v6
	v_cndmask_b32_e32 v95, v115, v95, vcc
...
.Lk_loop:
	...
	// Deterministic unweighted FP16 route workspace. Four result rows and
	// four N16 tiles are contiguous in N for each route.
	.irp r,64,65,66,67,68,69,70,71,72,73,74,75,76,77,78,79
	v_cvt_f16_f32_e32 v\r, v\r
	.endr
	v_lshlrev_b32_e32 v112, 12, v92
	v_lshlrev_b32_e32 v113, 12, v93
	v_lshlrev_b32_e32 v114, 12, v94
	v_lshlrev_b32_e32 v115, 12, v95
	v_add_u32_e32 v116, s28, v1
	v_lshlrev_b32_e32 v116, 1, v116
	.macro STORE_VALID address, value, packed
	v_lshrrev_b32_e32 v6, 24, v\packed
	...
	global_store_short v\address, v\value, s[20:21]
	...
	STORE_VALID 118, \a0, 84
	STORE_VALID 119, \a1, 85
	STORE_VALID 120, \a2, 86
	STORE_VALID 121, \a3, 87
	.endm
...
.Lend:
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_moe_down_m64n64_partial_f16_fp8_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_moe_down_m64n64_partial_f16_fp8_gfx950, .Lfunc_end0-qwen36_moe_down_m64n64_partial_f16_fp8_gfx950
...
amdhsa.kernels:
  - .args:
      ...
      - { .name: partial_f16, .offset: 64, .size: 8, .value_kind: global_buffer, .address_space: global, .actual_access: write_only }
    ...
    .name: qwen36_moe_down_m64n64_partial_f16_fp8_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 52
    .sgpr_spill_count: 0
    .symbol: qwen36_moe_down_m64n64_partial_f16_fp8_gfx950.kd
