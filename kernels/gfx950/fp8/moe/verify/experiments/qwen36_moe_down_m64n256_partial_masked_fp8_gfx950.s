...
// Two 32 KiB ping-pong buffers let the next K iteration write a disjoint slab
// without an end-of-iteration barrier.
// Grid: (8 N256 tiles, num_valid_ids/64, 1), workgroup: 256, LDS: 64 KiB.

	.amdgcn_target "amdgcn-amd-amdhsa--gfx950"
	.amdhsa_code_object_version 6
	.text
	.protected qwen36_moe_down_m64n256_partial_masked_fp8_gfx950
	.globl qwen36_moe_down_m64n256_partial_masked_fp8_gfx950
	.p2align 8
	.type qwen36_moe_down_m64n256_partial_masked_fp8_gfx950,@function
qwen36_moe_down_m64n256_partial_masked_fp8_gfx950:
...
.Lk_loop:
	...
	s_and_b32 s39, s29, 1
	s_lshl_b32 s39, s39, 15
	v_add_u32_e32 v102, s39, v96
	v_add_u32_e32 v103, s39, v97
	// Cooperative W2 load: sixteen 2 KiB N16xK128 tiles.
	...
	global_load_dwordx2 v[32:33], v101, s[32:33]
	global_load_dwordx2 v[34:35], v101, s[40:41]
	global_load_dwordx2 v[36:37], v101, s[42:43]
	global_load_dwordx2 v[38:39], v101, s[44:45]
	v_add_u32_e32 v101, 32768, v101
	global_load_dwordx2 v[40:41], v101, s[32:33]
	global_load_dwordx2 v[42:43], v101, s[40:41]
	global_load_dwordx2 v[44:45], v101, s[42:43]
	global_load_dwordx2 v[46:47], v101, s[44:45]
	...
	ds_write_b64 v102, v[32:33] offset:16384
	ds_write_b64 v102, v[34:35] offset:18432
	ds_write_b64 v102, v[36:37] offset:20480
	ds_write_b64 v102, v[38:39] offset:22528
	ds_write_b64 v102, v[40:41] offset:24576
	ds_write_b64 v102, v[42:43] offset:26624
	ds_write_b64 v102, v[44:45] offset:28672
	ds_write_b64 v102, v[46:47] offset:30720
	s_waitcnt lgkmcnt(0)
	s_barrier
	...
	ds_read_b128 v[16:19], v103 offset:16384
	ds_read_b128 v[20:23], v103 offset:17408
	ds_read_b128 v[24:27], v103 offset:18432
	ds_read_b128 v[28:31], v103 offset:19456
	ds_read_b128 v[32:35], v103 offset:20480
	ds_read_b128 v[36:39], v103 offset:21504
	ds_read_b128 v[40:43], v103 offset:22528
	ds_read_b128 v[44:47], v103 offset:23552
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_16x16x128_f8f6f4 v[48:51], v[8:15], v[16:23], 0
	v_mfma_f32_16x16x128_f8f6f4 v[52:55], v[8:15], v[24:31], 0
	v_mfma_f32_16x16x128_f8f6f4 v[56:59], v[8:15], v[32:39], 0
	...
	ds_read_b128 v[16:19], v103 offset:24576
	ds_read_b128 v[20:23], v103 offset:25600
	ds_read_b128 v[24:27], v103 offset:26624
	ds_read_b128 v[28:31], v103 offset:27648
	ds_read_b128 v[32:35], v103 offset:28672
	ds_read_b128 v[36:39], v103 offset:29696
	ds_read_b128 v[40:43], v103 offset:30720
	ds_read_b128 v[44:47], v103 offset:31744
	s_waitcnt lgkmcnt(0)
	v_mfma_f32_16x16x128_f8f6f4 v[48:51], v[8:15], v[16:23], 0
	v_mfma_f32_16x16x128_f8f6f4 v[52:55], v[8:15], v[24:31], 0
	v_mfma_f32_16x16x128_f8f6f4 v[56:59], v[8:15], v[32:39], 0
...
.Lend:
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_moe_down_m64n256_partial_masked_fp8_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_moe_down_m64n256_partial_masked_fp8_gfx950, .Lfunc_end0-qwen36_moe_down_m64n256_partial_masked_fp8_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_moe_down_m64n256_partial_masked_fp8_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 60
    .sgpr_spill_count: 0
    .symbol: qwen36_moe_down_m64n256_partial_masked_fp8_gfx950.kd
