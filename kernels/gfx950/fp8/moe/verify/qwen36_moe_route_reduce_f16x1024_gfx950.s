...
//
// The grouped down-projection kernel writes one unweighted scaled-FP16 partial for
// every [token, top-k slot, hidden column].  This kernel applies the nine
// router weights in FP32 and accumulates in the original top-k slot order before the
...
// Shape: partials [rows, 9, 2048] FP16, weights [rows, 9] FP32,
//        output [rows, 2048] BF16.

	.amdgcn_target "amdgcn-amd-amdhsa--gfx950"
	.amdhsa_code_object_version 6
	.text
	.protected qwen36_moe_route_reduce_f16x1024_gfx950
	.globl qwen36_moe_route_reduce_f16x1024_gfx950
	.p2align 8
	.type qwen36_moe_route_reduce_f16x1024_gfx950,@function
qwen36_moe_route_reduce_f16x1024_gfx950:
	// Kernargs: partial_f16x1024, topk_weights_f32, output_bf16.
	...
	// A route plane is 2048 FP16 values = 4096 bytes.  Issue all route
	// reads together, then perform the arithmetic in fixed slot order.
	global_load_ushort v3, v2, s[4:5]
	v_add_u32_e32 v12, 4096, v2
	global_load_ushort v4, v12, s[4:5]
	v_add_u32_e32 v12, 4096, v12
	global_load_ushort v5, v12, s[4:5]
	v_add_u32_e32 v12, 4096, v12
	global_load_ushort v6, v12, s[4:5]
	v_add_u32_e32 v12, 4096, v12
	global_load_ushort v7, v12, s[4:5]
	v_add_u32_e32 v12, 4096, v12
	global_load_ushort v8, v12, s[4:5]
	v_add_u32_e32 v12, 4096, v12
	global_load_ushort v9, v12, s[4:5]
	v_add_u32_e32 v12, 4096, v12
	global_load_ushort v10, v12, s[4:5]
	v_add_u32_e32 v12, 4096, v12
	global_load_ushort v11, v12, s[4:5]
	s_waitcnt vmcnt(0) & lgkmcnt(0)

	.irp r,3,4,5,6,7,8,9,10,11
	v_cvt_f32_f16_e32 v\r, v\r
	.endr
	...
	// Undo the producer's exact 2^10 scale once, after fixed-order FP32
	// accumulation, to avoid introducing nine extra rounding points.
	v_mul_f32_e32 v3, 0x3a800000, v3
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_moe_route_reduce_f16x1024_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_moe_route_reduce_f16x1024_gfx950, .Lfunc_end0-qwen36_moe_route_reduce_f16x1024_gfx950
...
amdhsa.kernels:
  - .agpr_count:     0
    ...
    .name: qwen36_moe_route_reduce_f16x1024_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 22
    .sgpr_spill_count: 0
    .symbol: qwen36_moe_route_reduce_f16x1024_gfx950.kd
    .vgpr_count: 16
    .vgpr_spill_count: 0
    .wavefront_size: 64
