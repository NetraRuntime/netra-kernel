...
//
// Experimental native-CDNA4 MFMA Qwen3.6 row-major MoE down projection.
//
// Match the deterministic Triton control's BLOCK_SIZE_K=32 arithmetic: each
// checkpoint K=128 quant block is four separately scaled native FP8 MFMAs.
// Each routed slot is accumulated in FP32, multiplied by its router weight,
// rounded to the BF16 intermediate-cache boundary, then reduced in slot order.
...
qwen36_moe_down_reduce_fp8_mfma_2wave_gfx950:
	...
	// Resident expert weights are logical contiguous [N,K].
	...
	// Wave 1 computes slots 5..8 and publishes one completed sum per slot.
	s_mov_b32 s18, 5
.Lwave1_slot:
...
.Lwave1_kblock:
	...
	v_mov_b32_e32 v28, 0
	v_mov_b32_e32 v29, 0
	v_mfma_f32_16x16x32_fp8_fp8 v[26:29], v[10:11], v[18:19], v[26:29]
	s_nop 15
	...
	v_mov_b32_e32 v28, 0
	v_mov_b32_e32 v29, 0
	v_mfma_f32_16x16x32_fp8_fp8 v[26:29], v[12:13], v[20:21], v[26:29]
	s_nop 15
	v_mul_f32_e32 v7, v8, v26
	v_add_f32_e32 v9, v9, v7
	...
	v_mov_b32_e32 v28, 0
	v_mov_b32_e32 v29, 0
	v_mfma_f32_16x16x32_fp8_fp8 v[26:29], v[14:15], v[22:23], v[26:29]
	s_nop 15
	v_mul_f32_e32 v7, v8, v26
	v_add_f32_e32 v9, v9, v7
	...
	v_mov_b32_e32 v28, 0
	v_mov_b32_e32 v29, 0
	v_mfma_f32_16x16x32_fp8_fp8 v[26:29], v[16:17], v[24:25], v[26:29]
	s_nop 15
	v_mul_f32_e32 v7, v8, v26
	v_add_f32_e32 v9, v9, v7
	...
	v_cvt_pk_bf16_f32 v8, v9, v9
	v_lshlrev_b32_e32 v9, 16, v8
	// LDS layout: [slot - 5][column], 64 bytes per slot sum.
	s_sub_u32 s37, s18, 5
...
.Lwave0_kblock:
	...
	// All wave-1 writes are visible after the barrier. Add slots 5..8.
	s_barrier
	v_cmp_gt_u32_e32 vcc, 16, v30
	s_and_saveexec_b64 s[38:39], vcc
	s_mov_b32 s18, 0
