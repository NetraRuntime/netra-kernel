...
//
// Nine wave64s share each 16-column output tile, one wave per routed expert.
// Every wave writes its four individually scaled K-block contributions to
// LDS. After one barrier, wave 0 consumes the 36 contributions in exact
// slot-major/K-block-major order. This preserves the validated serial FP32
// accumulation contract while exposing all nine experts concurrently.

	.amdgcn_target "amdgcn-amd-amdhsa--gfx950"
	.amdhsa_code_object_version 6
	.text
	.protected qwen36_moe_down_reduce_fp8_mfma_9wave_gfx950
	.globl qwen36_moe_down_reduce_fp8_mfma_9wave_gfx950
	.p2align 8
	.type qwen36_moe_down_reduce_fp8_mfma_9wave_gfx950,@function
qwen36_moe_down_reduce_fp8_mfma_9wave_gfx950:
	...
	// v30 is the wave-local lane and v31 is the routed slot/wave index.
	// v_readfirstlane turns the wave-uniform slot into an SGPR so the
	// checkpoint expert ID can retain scalar addressing.
	...
	// Slot-local activation/scales and routing.
...
.Lkblock:
	...
	// LDS layout: [slot][K block][column], 64 bytes per contribution.
	// Only the first MFMA lane group owns output row zero.
	s_lshl_b32 s37, s18, 2
	...
	// All waves participate in the barrier. Only wave 0 performs the exact
	// ordered reduction and output conversion.
	s_waitcnt lgkmcnt(0)
	s_barrier
...
.Lend:
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_moe_down_reduce_fp8_mfma_9wave_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_moe_down_reduce_fp8_mfma_9wave_gfx950, .Lfunc_end0-qwen36_moe_down_reduce_fp8_mfma_9wave_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_moe_down_reduce_fp8_mfma_9wave_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 42
    .sgpr_spill_count: 0
    .symbol: qwen36_moe_down_reduce_fp8_mfma_9wave_gfx950.kd
