...
// AITER-shuffled resident weights and a pipelined K-block load schedule.
// The next block's loads overlap the current MFMA result dependency window;
// the FP32 scale/multiply/add order remains identical to production.
	...
	.endif
	.text
	.protected qwen36_moe_gate_up_fp8_mfma_load_pipeline_shuffled_gfx950
	.globl qwen36_moe_gate_up_fp8_mfma_load_pipeline_shuffled_gfx950
	.p2align 8
	.type qwen36_moe_gate_up_fp8_mfma_load_pipeline_shuffled_gfx950,@function
qwen36_moe_gate_up_fp8_mfma_load_pipeline_shuffled_gfx950:
...
.Lkblock:
	...
	// then rotate the already-loaded scales into the live pair.
...
.Llast_block:
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_moe_gate_up_fp8_mfma_load_pipeline_shuffled_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_moe_gate_up_fp8_mfma_load_pipeline_shuffled_gfx950, .Lfunc_end0-qwen36_moe_gate_up_fp8_mfma_load_pipeline_shuffled_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_moe_gate_up_fp8_mfma_load_pipeline_shuffled_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 40
    .sgpr_spill_count: 0
    .symbol: qwen36_moe_gate_up_fp8_mfma_load_pipeline_shuffled_gfx950.kd
