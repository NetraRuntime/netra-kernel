...
//
// Experimental native-CDNA4 Qwen3.6 rowwise routed gate/up projection with
// AITER-shuffled resident weights and a load/accumulate overlap schedule.
// The next block's loads overlap both the current MFMA result dependency
// window and the preceding result's FP32 scale/multiply/add sequence.
	...
	.endif
	.text
	.protected qwen36_moe_gate_up_fp8_mfma_load_pipeline_overlap_shuffled_gfx950
	.globl qwen36_moe_gate_up_fp8_mfma_load_pipeline_overlap_shuffled_gfx950
	.p2align 8
	.type qwen36_moe_gate_up_fp8_mfma_load_pipeline_overlap_shuffled_gfx950,@function
qwen36_moe_gate_up_fp8_mfma_load_pipeline_overlap_shuffled_gfx950:
...
.Llast_block:
	...
	.p2align 6, 0
	.amdhsa_kernel qwen36_moe_gate_up_fp8_mfma_load_pipeline_overlap_shuffled_gfx950
	...
	.text
.Lfunc_end0:
	.size qwen36_moe_gate_up_fp8_mfma_load_pipeline_overlap_shuffled_gfx950, .Lfunc_end0-qwen36_moe_gate_up_fp8_mfma_load_pipeline_overlap_shuffled_gfx950
...
amdhsa.kernels:
  - .args:
    ...
    .name: qwen36_moe_gate_up_fp8_mfma_load_pipeline_overlap_shuffled_gfx950
    .private_segment_fixed_size: 0
    .sgpr_count: 40
    .sgpr_spill_count: 0
    .symbol: qwen36_moe_gate_up_fp8_mfma_load_pipeline_overlap_shuffled_gfx950.kd
