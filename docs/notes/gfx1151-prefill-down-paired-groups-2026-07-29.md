...
Artifacts: `harness/gfx1151/mxfp4/prefill/benchmark_prefill_down_pair.hip`, `results/kernels/gfx1151/prefill-down-pair-prototype.txt`, and `docs/notes/disassembly/prefill-down-pair-gfx1151/`.
