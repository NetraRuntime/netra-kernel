...
- `scripts/rocm/causal_conv1d_stream64_gfx1151.s`
- `scripts/rocm/causal_conv1d_state_update_gfx1151.s`
- `scripts/rocm/causal_conv1d_stream64_launcher.hip`
- `scripts/rocm/benchmark_causal_conv1d_stream64.py`

Disassemblies are in `docs/netra/notes/disassembly/causal-conv-gfx1151/`. Future work should reproduce Triton's packed BF16 dot/rounding order exactly before repeating the real-checkpoint gate.
