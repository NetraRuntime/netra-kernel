...
| SiLU x up feeding down projection | Pending; down cache-policy subtest rejected | Exact G1280 down projection measured 7.34095 ms default versus 7.40110 ms with immutable-weight `glc`; outputs were byte-identical. | Cache bypass is rejected. A materially different paired-group weight-reuse schedule is the next down-projection candidate. |
