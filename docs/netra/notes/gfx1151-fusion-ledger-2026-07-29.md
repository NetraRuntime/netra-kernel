...
| Router-weight application + expert reduction + residual | Rejected pending full-stack determinism | Fixed pairwise raw reduction is exact to its FP32 tree and temporarily cuts 32K serving to about 27.0 s, but identical fresh servers still select pair-B token 3709 or 96043. | Retain as a negative oracle; locate remaining unordered reductions before promotion. |
