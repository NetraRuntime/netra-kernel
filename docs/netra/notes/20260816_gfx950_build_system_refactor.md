...
- Added `tools/build/lib/qwen36_gdn_variants.sh` as the single mapping from GDN
...
- Added `build_gfx950_qwen36_production.sh` as the canonical production bundle.
  Its GDN verification component explicitly pins interleaved variant 17,
  Triton-exact precompute 7, lossless K0, share-QK, and dynamic wavegroups.
