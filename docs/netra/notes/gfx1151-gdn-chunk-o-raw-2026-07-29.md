...
`scripts/rocm/gdn_chunk_o_bv32_gfx1151.s` is a hand-written four-wave gfx1151
...
`docs/netra/notes/gfx1151-gdn-chunk-o-raw-2026-07-29.json`. Before/oracle
disassemblies and static counts are under
`docs/netra/notes/disassembly/gfx1151-gdn-chunk-o-2026-07-29/` and
`docs/netra/notes/gfx1151-gdn-chunk-o-oracle-disassembly-2026-07-29.json`.
